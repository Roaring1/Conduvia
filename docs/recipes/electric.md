...
graph LR
  i_raw_ore_bauxite["<img src='../../assets/icons/raw_ore_bauxite.png' class='mmd-ico' />raw bauxite ore"]
  i_crushed_ore_bauxite["<img src='../../assets/icons/crushed_ore_bauxite.png' class='mmd-ico' />crushed bauxite"]
  i_stone_dust["<img src='../../assets/icons/stone_dust.png' class='mmd-ico' />stone dust"]
  i_sodium_hydroxide["<img src='../../assets/icons/sodium_hydroxide.png' class='mmd-ico' />sodium hydroxide"]
  i_liquor_sodium_aluminate["<img src='../../assets/icons/liquor_sodium_aluminate.png' class='mmd-ico' />sodium aluminate liquor"]
  i_waste_red_mud["<img src='../../assets/icons/waste_red_mud.png' class='mmd-ico' />red mud"]
  i_hydrate_gibbsite["<img src='../../assets/icons/hydrate_gibbsite.png' class='mmd-ico' />aluminum hydroxide (gibbsite)"]
  i_intermediate_alumina["<img src='../../assets/icons/intermediate_alumina.png' class='mmd-ico' />alumina"]
  i_coke_fuel["<img src='../../assets/icons/coke_fuel.png' class='mmd-ico' />coke fuel"]
  i_anode_carbon["<img src='../../assets/icons/anode_carbon.png' class='mmd-ico' />prebaked carbon anode"]
  i_cryolite["<img src='../../assets/icons/cryolite.png' class='mmd-ico' />cryolite"]
  i_metal_aluminum_ingot["<img src='../../assets/icons/metal_aluminum_ingot.png' class='mmd-ico' />aluminum ingot"]
  i_gas_co2["<img src='../../assets/icons/gas_co2.png' class='mmd-ico' />carbon dioxide gas"]
...
<div class="rc-meta"><span class="rc-stn"><a class="stn-link" href="../../stations/#anode_baking_furnace">Prebake Anode Furnace</a></span> <span class="rc-time">75s</span> <span class="rc-tier">T3</span> <span class="rc-energy">90 kJ</span></div>
...
<div class="rc-meta"><span class="rc-stn"><a class="stn-link" href="../../stations/#stamp_mill_manual_trip_hammer">Trip Hammer</a></span> <span class="rc-time">30s</span> <span class="rc-tier">T2</span> <span class="rc-energy">16 kJ</span> <span class="rc-bp">+1 byproduct</span></div>
...
<div class="rc-meta"><span class="rc-stn"><a class="stn-link" href="../../stations/#precipitation_tank">Gibbsite Precipitation Tank</a></span> <span class="rc-time">180s</span> <span class="rc-tier">T3</span> <span class="rc-energy">35 kJ</span> <span class="rc-bp">+1 byproduct</span></div>
...
<div class="rc-meta"><span class="rc-stn"><a class="stn-link" href="../../stations/#rotary_calciner_kiln">Rotary Calcining Kiln (RKEF dry/reduce)</a></span> <span class="rc-time">90s</span> <span class="rc-tier">T3</span> <span class="rc-energy">120 kJ</span></div>
...
<div class="rc-meta"><span class="rc-stn"><a class="stn-link" href="../../stations/#bayer_digester">Bayer Digestion Autoclave</a></span> <span class="rc-time">120s</span> <span class="rc-tier">T3</span> <span class="rc-energy">140 kJ</span> <span class="rc-bp">+1 byproduct</span></div>
...
<div class="rc-meta"><span class="rc-stn"><a class="stn-link" href="../../stations/#hall_heroult_cell">Hall-Heroult Reduction Cell (Pot)</a></span> <span class="rc-time">200s</span> <span class="rc-tier">T4</span> <span class="rc-energy">600 kJ</span> <span class="rc-bp">+1 byproduct</span></div>
...
%%{init: {'securityLevel':'loose','flowchart':{'htmlLabels':true,'curve':'basis','nodeSpacing':38,'rankSpacing':70}, 'theme':'base', 'themeVariables':{'fontSize':'13px'}}}%%
graph LR
  i_stainless_steel_sheet["<img src='../../assets/icons/stainless_steel_sheet.png' class='mmd-ico' />stainless steel sheet"]
  i_cell_metal["<img src='../../assets/icons/cell_metal.png' class='mmd-ico' />metal cell"]
  i_glass_tube["<img src='../../assets/icons/glass_tube.png' class='mmd-ico' />borosilicate glass tube"]
  i_cell_glass["<img src='../../assets/icons/cell_glass.png' class='mmd-ico' />glass cell"]
  i_water_raw["<img src='../../assets/icons/water_raw.png' class='mmd-ico' />raw water"]
  i_cell_metal_water_raw["<img src='../../assets/icons/cell_metal_water_raw.png' class='mmd-ico' />metal cell (water)"]
  i_acid_sulfuric["<img src='../../assets/icons/acid_sulfuric.png' class='mmd-ico' />sulfuric acid"]
  i_cell_metal_acid_sulfuric["<img src='../../assets/icons/cell_metal_acid_sulfuric.png' class='mmd-ico' />metal cell (sulfuric acid)"]
  i_sodium_hydroxide["<img src='../../assets/icons/sodium_hydroxide.png' class='mmd-ico' />sodium hydroxide"]
  i_cell_metal_sodium_hydroxide["<img src='../../assets/icons/cell_metal_sodium_hydroxide.png' class='mmd-ico' />metal cell (sodium hydroxide)"]
  i_cell_glass_water_raw["<img src='../../assets/icons/cell_glass_water_raw.png' class='mmd-ico' />glass cell (water)"]
...
<div class="rc-meta"><span class="rc-stn"><a class="stn-link" href="../../stations/#glass_bench">Glass Bench</a></span> <span class="rc-time">45s</span> <span class="rc-tier">T3</span> <span class="rc-energy">60 kJ</span></div>
...
<div class="rc-meta"><span class="rc-stn"><a class="stn-link" href="../../stations/#reagent_filling_line">Reagent Filling & Sealing Line</a></span> <span class="rc-time">20s</span> <span class="rc-tier">T3</span> <span class="rc-energy">15 kJ</span></div>
...
<div class="rc-meta"><span class="rc-stn"><a class="stn-link" href="../../stations/#sheet_metal_press">Sheet-Metal Forming & Seaming Press</a></span> <span class="rc-time">60s</span> <span class="rc-tier">T4</span> <span class="rc-energy">90 kJ</span></div>
...
<div class="rc-meta"><span class="rc-stn"><a class="stn-link" href="../../stations/#reagent_filling_line">Reagent Filling & Sealing Line</a></span> <span class="rc-time">25s</span> <span class="rc-tier">T4</span> <span class="rc-energy">20 kJ</span></div>
...
<div class="rc-meta"><span class="rc-stn"><a class="stn-link" href="../../stations/#reagent_filling_line">Reagent Filling & Sealing Line</a></span> <span class="rc-time">20s</span> <span class="rc-tier">T4</span> <span class="rc-energy">15 kJ</span></div>
...
%%{init: {'securityLevel':'loose','flowchart':{'htmlLabels':true,'curve':'basis','nodeSpacing':38,'rankSpacing':70}, 'theme':'base', 'themeVariables':{'fontSize':'13px'}}}%%
graph LR
  i_raw_ore_halite["<img src='../../assets/icons/raw_ore_halite.png' class='mmd-ico' />raw halite ore"]
  i_water_raw["<img src='../../assets/icons/water_raw.png' class='mmd-ico' />raw water"]
  i_brine_solution["<img src='../../assets/icons/brine_solution.png' class='mmd-ico' />brine solution"]
  i_brine_purified["<img src='../../assets/icons/brine_purified.png' class='mmd-ico' />purified brine"]
  i_waste_tailings["<img src='../../assets/icons/waste_tailings.png' class='mmd-ico' />tailings"]
  i_gas_chlorine["<img src='../../assets/icons/gas_chlorine.png' class='mmd-ico' />chlorine gas"]
  i_caustic_dilute["<img src='../../assets/icons/caustic_dilute.png' class='mmd-ico' />dilute cell caustic"]
  i_gas_hydrogen["<img src='../../assets/icons/gas_hydrogen.png' class='mmd-ico' />hydrogen gas"]
  i_sodium_hydroxide["<img src='../../assets/icons/sodium_hydroxide.png' class='mmd-ico' />sodium hydroxide"]
...
<div class="rc-meta"><span class="rc-stn"><a class="stn-link" href="../../stations/#brine_treatment_unit">Brine Saturation & Softening Unit</a></span> <span class="rc-time">45s</span> <span class="rc-tier">T3</span> <span class="rc-energy">40 kJ</span> <span class="rc-bp">+1 byproduct</span></div>
...
<div class="rc-meta"><span class="rc-stn"><a class="stn-link" href="../../stations/#brine_treatment_unit">Brine Saturation & Softening Unit</a></span> <span class="rc-time">30s</span> <span class="rc-tier">T2</span> <span class="rc-energy">20 kJ</span></div>
...
<div class="rc-meta"><span class="rc-stn"><a class="stn-link" href="../../stations/#membrane_electrolysis_cell">Chlor-Alkali Membrane Cell</a></span> <span class="rc-time">120s</span> <span class="rc-tier">T3</span> <span class="rc-energy">350 kJ</span> <span class="rc-bp">+2 byproducts</span></div>
...
<div class="rc-meta"><span class="rc-stn"><a class="stn-link" href="../../stations/#caustic_evaporator">Caustic Concentration Evaporator</a></span> <span class="rc-time">60s</span> <span class="rc-tier">T3</span> <span class="rc-energy">110 kJ</span> <span class="rc-bp">+1 byproduct</span></div>
...
%%{init: {'securityLevel':'loose','flowchart':{'htmlLabels':true,'curve':'basis','nodeSpacing':38,'rankSpacing':70}, 'theme':'base', 'themeVariables':{'fontSize':'13px'}}}%%
graph LR
  i_raw_ore_cobaltite["<img src='../../assets/icons/raw_ore_cobaltite.png' class='mmd-ico' />raw cobaltite ore"]
  i_gas_oxygen["<img src='../../assets/icons/gas_oxygen.png' class='mmd-ico' />oxygen gas"]
  i_cobalt_oxide_roasted["<img src='../../assets/icons/cobalt_oxide_roasted.png' class='mmd-ico' />roasted cobalt oxide"]
  i_gas_so2["<img src='../../assets/icons/gas_so2.png' class='mmd-ico' />sulfur dioxide gas"]
  i_arsenic_trioxide["<img src='../../assets/icons/arsenic_trioxide.png' class='mmd-ico' />arsenic trioxide (toxic)"]
  i_acid_sulfuric["<img src='../../assets/icons/acid_sulfuric.png' class='mmd-ico' />sulfuric acid"]
  i_cobalt_sulfate_solution["<img src='../../assets/icons/cobalt_sulfate_solution.png' class='mmd-ico' />cobalt sulfate liquor"]
  i_waste_tailings["<img src='../../assets/icons/waste_tailings.png' class='mmd-ico' />tailings"]
  i_cobalt_purified_solution["<img src='../../assets/icons/cobalt_purified_solution.png' class='mmd-ico' />purified cobalt solution"]
  i_nickel_concentrate["<img src='../../assets/icons/nickel_concentrate.png' class='mmd-ico' />nickel concentrate"]
  i_dc_charge["<img src='../../assets/icons/dc_charge.png' class='mmd-ico' />DC power charge"]
  i_cobalt_cathode["<img src='../../assets/icons/cobalt_cathode.png' class='mmd-ico' />cobalt cathode"]
  i_slag["<img src='../../assets/icons/slag.png' class='mmd-ico' />slag"]
...
<div class="rc-meta"><span class="rc-stn"><a class="stn-link" href="../../stations/#electrowinning_cell">Electrowinning Cell (Pb anode / SS cathode)</a></span> <span class="rc-time">120s</span> <span class="rc-tier">T4</span> <span class="rc-energy">200 kJ</span> <span class="rc-bp">+1 byproduct</span></div>
...
<div class="rc-meta"><span class="rc-stn"><a class="stn-link" href="../../stations/#roasting_pit">Roasting Pit</a></span> <span class="rc-time">100s</span> <span class="rc-tier">T3</span> <span class="rc-energy">110 kJ</span> <span class="rc-bp">+2 byproducts</span></div>
...
<div class="rc-meta"><span class="rc-stn"><a class="stn-link" href="../../stations/#sx_mixer_settler">Solvent-Extraction Mixer-Settler (LIX)</a></span> <span class="rc-time">140s</span> <span class="rc-tier">T4</span> <span class="rc-energy">120 kJ</span> <span class="rc-bp">+1 byproduct</span></div>
...
<div class="rc-meta"><span class="rc-stn"><a class="stn-link" href="../../stations/#heap_leach_pad">Heap Leach Pad (acid irrigation)</a></span> <span class="rc-time">120s</span> <span class="rc-tier">T4</span> <span class="rc-energy">90 kJ</span> <span class="rc-bp">+1 byproduct</span></div>
...
%%{init: {'securityLevel':'loose','flowchart':{'htmlLabels':true,'curve':'basis','nodeSpacing':38,'rankSpacing':70}, 'theme':'base', 'themeVariables':{'fontSize':'13px'}}}%%
graph LR
  i_air_raw["<img src='../../assets/icons/air_raw.png' class='mmd-ico' />compressed air"]
  i_liquid_air["<img src='../../assets/icons/liquid_air.png' class='mmd-ico' />liquid air"]
  i_gas_nitrogen["<img src='../../assets/icons/gas_nitrogen.png' class='mmd-ico' />nitrogen gas"]
  i_gas_oxygen["<img src='../../assets/icons/gas_oxygen.png' class='mmd-ico' />oxygen gas"]
  i_gas_argon["<img src='../../assets/icons/gas_argon.png' class='mmd-ico' />argon gas"]
  i_gas_hydrogen["<img src='../../assets/icons/gas_hydrogen.png' class='mmd-ico' />hydrogen gas"]
  i_gas_ammonia["<img src='../../assets/icons/gas_ammonia.png' class='mmd-ico' />ammonia gas"]
  i_steel_ingot["<img src='../../assets/icons/steel_ingot.png' class='mmd-ico' />steel ingot"]
  i_cylinder_gas_basic["<img src='../../assets/icons/cylinder_gas_basic.png' class='mmd-ico' />basic gas cylinder"]
...
<div class="rc-meta"><span class="rc-stn"><a class="stn-link" href="../../stations/#station_gas_compressor">Gas Compressor</a></span> <span class="rc-time">5s</span> <span class="rc-tier">T1</span></div>
...
<div class="rc-meta"><span class="rc-stn"><a class="stn-link" href="../../stations/#machine_shop_steam">Steam Machine Shop</a></span> <span class="rc-time">70s</span> <span class="rc-tier">T3</span> <span class="rc-energy">90 kJ</span></div>
...
<div class="rc-meta"><span class="rc-stn"><a class="stn-link" href="../../stations/#haber_bosch_reactor">Haber-Bosch Ammonia Converter (iron cat., high P)</a></span> <span class="rc-time">150s</span> <span class="rc-tier">T4</span> <span class="rc-energy">320 kJ</span></div>
...
<div class="rc-meta"><span class="rc-stn"><a class="stn-link" href="../../stations/#air_separation_unit">Cryogenic Air Separation Unit (ASU)</a></span> <span class="rc-time">90s</span> <span class="rc-tier">T3</span> <span class="rc-energy">120 kJ</span> <span class="rc-bp">+2 byproducts</span></div>
...
<div class="rc-meta"><span class="rc-stn"><a class="stn-link" href="../../stations/#air_separation_unit">Cryogenic Air Separation Unit (ASU)</a></span> <span class="rc-time">60s</span> <span class="rc-tier">T3</span> <span class="rc-energy">220 kJ</span></div>
...
%%{init: {'securityLevel':'loose','flowchart':{'htmlLabels':true,'curve':'basis','nodeSpacing':38,'rankSpacing':70}, 'theme':'base', 'themeVariables':{'fontSize':'13px'}}}%%
graph LR
  i_raw_ore_gypsum["<img src='../../assets/icons/raw_ore_gypsum.png' class='mmd-ico' />raw gypsum ore"]
  i_plaster_of_paris["<img src='../../assets/icons/plaster_of_paris.png' class='mmd-ico' />plaster of Paris"]
  i_waste_gypsum_refined["<img src='../../assets/icons/waste_gypsum_refined.png' class='mmd-ico' />refined gypsum"]
  i_water_raw["<img src='../../assets/icons/water_raw.png' class='mmd-ico' />raw water"]
  i_gypsum_board["<img src='../../assets/icons/gypsum_board.png' class='mmd-ico' />gypsum board (drywall)"]
  i_coke_fuel["<img src='../../assets/icons/coke_fuel.png' class='mmd-ico' />coke fuel"]
  i_raw_ore_silica["<img src='../../assets/icons/raw_ore_silica.png' class='mmd-ico' />raw silica ore"]
  i_gas_so2["<img src='../../assets/icons/gas_so2.png' class='mmd-ico' />sulfur dioxide gas"]
  i_cement_clinker["<img src='../../assets/icons/cement_clinker.png' class='mmd-ico' />cement clinker"]
  i_portland_cement["<img src='../../assets/icons/portland_cement.png' class='mmd-ico' />Portland cement"]
...
<div class="rc-meta"><span class="rc-stn"><a class="stn-link" href="../../stations/#rotary_calciner_kiln">Rotary Calcining Kiln (RKEF dry/reduce)</a></span> <span class="rc-time">260s</span> <span class="rc-tier">T4</span> <span class="rc-energy">250 kJ</span> <span class="rc-bp">+1 byproduct</span></div>
...
<div class="rc-meta"><span class="rc-stn"><a class="stn-link" href="../../stations/#clay_casting_pit">Clay Casting Pit</a></span> <span class="rc-time">40s</span> <span class="rc-tier">T2</span> <span class="rc-energy">20 kJ</span></div>
...
<div class="rc-meta"><span class="rc-stn"><a class="stn-link" href="../../stations/#rotary_calciner_kiln">Rotary Calcining Kiln (RKEF dry/reduce)</a></span> <span class="rc-time">70s</span> <span class="rc-tier">T2</span> <span class="rc-energy">70 kJ</span></div>
...
<div class="rc-meta"><span class="rc-stn"><a class="stn-link" href="../../stations/#rotary_calciner_kiln">Rotary Calcining Kiln (RKEF dry/reduce)</a></span> <span class="rc-time">70s</span> <span class="rc-tier">T3</span> <span class="rc-energy">70 kJ</span></div>
...
<div class="rc-meta"><span class="rc-stn"><a class="stn-link" href="../../stations/#cement_ball_mill">Cement Ball Mill</a></span> <span class="rc-time">90s</span> <span class="rc-tier">T3</span> <span class="rc-energy">90 kJ</span></div>
...
%%{init: {'securityLevel':'loose','flowchart':{'htmlLabels':true,'curve':'basis','nodeSpacing':38,'rankSpacing':70}, 'theme':'base', 'themeVariables':{'fontSize':'13px'}}}%%
graph LR
  i_raw_ore_galena["<img src='../../assets/icons/raw_ore_galena.png' class='mmd-ico' />raw galena ore"]
  i_concentrate_galena["<img src='../../assets/icons/concentrate_galena.png' class='mmd-ico' />galena concentrate"]
  i_waste_tailings["<img src='../../assets/icons/waste_tailings.png' class='mmd-ico' />tailings"]
  i_gas_oxygen["<img src='../../assets/icons/gas_oxygen.png' class='mmd-ico' />oxygen gas"]
  i_lead_sinter_oxide["<img src='../../assets/icons/lead_sinter_oxide.png' class='mmd-ico' />lead oxide sinter"]
  i_gas_so2["<img src='../../assets/icons/gas_so2.png' class='mmd-ico' />sulfur dioxide gas"]
  i_coke_fuel["<img src='../../assets/icons/coke_fuel.png' class='mmd-ico' />coke fuel"]
  i_limestone_flux["<img src='../../assets/icons/limestone_flux.png' class='mmd-ico' />limestone flux"]
  i_lead_bullion["<img src='../../assets/icons/lead_bullion.png' class='mmd-ico' />crude lead bullion"]
  i_slag["<img src='../../assets/icons/slag.png' class='mmd-ico' />slag"]
  i_gas_co2["<img src='../../assets/icons/gas_co2.png' class='mmd-ico' />carbon dioxide gas"]
  i_metal_zinc_ingot["<img src='../../assets/icons/metal_zinc_ingot.png' class='mmd-ico' />zinc ingot"]
  i_lead_softened["<img src='../../assets/icons/lead_softened.png' class='mmd-ico' />softened lead"]
  i_silver_zinc_crust["<img src='../../assets/icons/silver_zinc_crust.png' class='mmd-ico' />silver-zinc crust"]
  i_silver_dore["<img src='../../assets/icons/silver_dore.png' class='mmd-ico' />silver dore"]
  i_litharge_pbo["<img src='../../assets/icons/litharge_pbo.png' class='mmd-ico' />litharge (PbO)"]
  i_metal_lead_ingot["<img src='../../assets/icons/metal_lead_ingot.png' class='mmd-ico' />lead ingot"]
...
<div class="rc-meta"><span class="rc-stn"><a class="stn-link" href="../../stations/#froth_flotation_cell">Froth Flotation Cell</a></span> <span class="rc-time">60s</span> <span class="rc-tier">T2</span> <span class="rc-energy">40 kJ</span> <span class="rc-bp">+1 byproduct</span></div>
...
<div class="rc-meta"><span class="rc-stn"><a class="stn-link" href="../../stations/#blast_furnace_small">Blast Furnace</a></span> <span class="rc-time">220s</span> <span class="rc-tier">T3</span> <span class="rc-energy">240 kJ</span> <span class="rc-bp">+2 byproducts</span></div>
...
<div class="rc-meta"><span class="rc-stn"><a class="stn-link" href="../../stations/#sinter_strand">Sinter Strand (Dwight-Lloyd)</a></span> <span class="rc-time">110s</span> <span class="rc-tier">T3</span> <span class="rc-energy">120 kJ</span> <span class="rc-bp">+1 byproduct</span></div>
...
<div class="rc-meta"><span class="rc-stn"><a class="stn-link" href="../../stations/#fire_refining_furnace">Fire-Refining Furnace</a></span> <span class="rc-time">130s</span> <span class="rc-tier">T3</span> <span class="rc-energy">110 kJ</span> <span class="rc-bp">+1 byproduct</span></div>
...
<div class="rc-meta"><span class="rc-stn"><a class="stn-link" href="../../stations/#fire_refining_furnace">Fire-Refining Furnace</a></span> <span class="rc-time">90s</span> <span class="rc-tier">T3</span> <span class="rc-energy">80 kJ</span></div>
...
<div class="rc-meta"><span class="rc-stn"><a class="stn-link" href="../../stations/#cupellation_hearth">Cupellation Hearth (silver assay/refine)</a></span> <span class="rc-time">150s</span> <span class="rc-tier">T3</span> <span class="rc-energy">140 kJ</span> <span class="rc-bp">+1 byproduct</span></div>
...
%%{init: {'securityLevel':'loose','flowchart':{'htmlLabels':true,'curve':'basis','nodeSpacing':38,'rankSpacing':70}, 'theme':'base', 'themeVariables':{'fontSize':'13px'}}}%%
graph LR
  i_raw_ore_spodumene["<img src='../../assets/icons/raw_ore_spodumene.png' class='mmd-ico' />raw spodumene ore"]
  i_spodumene_beta["<img src='../../assets/icons/spodumene_beta.png' class='mmd-ico' />beta-spodumene"]
  i_acid_sulfuric["<img src='../../assets/icons/acid_sulfuric.png' class='mmd-ico' />sulfuric acid"]
  i_lithium_sulfate_crude["<img src='../../assets/icons/lithium_sulfate_crude.png' class='mmd-ico' />crude lithium sulfate"]
  i_waste_tailings["<img src='../../assets/icons/waste_tailings.png' class='mmd-ico' />tailings"]
  i_burned_lime_quicklime["<img src='../../assets/icons/burned_lime_quicklime.png' class='mmd-ico' />burned lime (quicklime)"]
  i_lithium_sulfate_solution["<img src='../../assets/icons/lithium_sulfate_solution.png' class='mmd-ico' />lithium sulfate liquor"]
  i_sodium_hydroxide["<img src='../../assets/icons/sodium_hydroxide.png' class='mmd-ico' />sodium hydroxide"]
  i_lithium_hydroxide["<img src='../../assets/icons/lithium_hydroxide.png' class='mmd-ico' />lithium hydroxide monohydrate"]
  i_salt_sodium_sulfate["<img src='../../assets/icons/salt_sodium_sulfate.png' class='mmd-ico' />sodium sulfate"]
  i_gas_co2["<img src='../../assets/icons/gas_co2.png' class='mmd-ico' />carbon dioxide gas"]
  i_lithium_carbonate["<img src='../../assets/icons/lithium_carbonate.png' class='mmd-ico' />lithium carbonate (battery grade)"]
...
<div class="rc-meta"><span class="rc-stn"><a class="stn-link" href="../../stations/#carbonation_reactor">Carbonation Precipitation Reactor</a></span> <span class="rc-time">90s</span> <span class="rc-tier">T4</span> <span class="rc-energy">70 kJ</span></div>
...
<div class="rc-meta"><span class="rc-stn"><a class="stn-link" href="../../stations/#caustic_digester_autoclave">Caustic Digester Autoclave (alkali leach)</a></span> <span class="rc-time">110s</span> <span class="rc-tier">T4</span> <span class="rc-energy">80 kJ</span> <span class="rc-bp">+1 byproduct</span></div>
...
<div class="rc-meta"><span class="rc-stn"><a class="stn-link" href="../../stations/#li_acid_roast_kiln">Sulfation Acid-Roast Kiln</a></span> <span class="rc-time">200s</span> <span class="rc-tier">T4</span> <span class="rc-energy">200 kJ</span> <span class="rc-bp">+1 byproduct</span></div>
...
<div class="rc-meta"><span class="rc-stn"><a class="stn-link" href="../../stations/#rotary_calciner_kiln">Rotary Calcining Kiln (RKEF dry/reduce)</a></span> <span class="rc-time">180s</span> <span class="rc-tier">T4</span> <span class="rc-energy">240 kJ</span></div>
...
%%{init: {'securityLevel':'loose','flowchart':{'htmlLabels':true,'curve':'basis','nodeSpacing':38,'rankSpacing':70}, 'theme':'base', 'themeVariables':{'fontSize':'13px'}}}%%
graph LR
  i_raw_ore_dolomite["<img src='../../assets/icons/raw_ore_dolomite.png' class='mmd-ico' />dolomite"]
  i_dolime_calcined["<img src='../../assets/icons/dolime_calcined.png' class='mmd-ico' />calcined dolime (MgO·CaO)"]
  i_gas_co2["<img src='../../assets/icons/gas_co2.png' class='mmd-ico' />carbon dioxide gas"]
  i_raw_ore_silica["<img src='../../assets/icons/raw_ore_silica.png' class='mmd-ico' />raw silica ore"]
  i_pig_iron_ingot["<img src='../../assets/icons/pig_iron_ingot.png' class='mmd-ico' />pig iron ingot"]
  i_coke_fuel["<img src='../../assets/icons/coke_fuel.png' class='mmd-ico' />coke fuel"]
  i_ferrosilicon["<img src='../../assets/icons/ferrosilicon.png' class='mmd-ico' />ferrosilicon (FeSi)"]
  i_magnesium_crown["<img src='../../assets/icons/magnesium_crown.png' class='mmd-ico' />magnesium crown (crude)"]
  i_dicalcium_silicate_slag["<img src='../../assets/icons/dicalcium_silicate_slag.png' class='mmd-ico' />dicalcium silicate slag"]
  i_magnesium_ingot["<img src='../../assets/icons/magnesium_ingot.png' class='mmd-ico' />magnesium ingot"]
  i_brine_solution["<img src='../../assets/icons/brine_solution.png' class='mmd-ico' />brine solution"]
  i_burned_lime_quicklime["<img src='../../assets/icons/burned_lime_quicklime.png' class='mmd-ico' />burned lime (quicklime)"]
  i_magnesium_hydroxide["<img src='../../assets/icons/magnesium_hydroxide.png' class='mmd-ico' />magnesium hydroxide"]
  i_waste_tailings["<img src='../../assets/icons/waste_tailings.png' class='mmd-ico' />tailings"]
  i_gas_chlorine["<img src='../../assets/icons/gas_chlorine.png' class='mmd-ico' />chlorine gas"]
  i_magnesium_chloride_anhydrous["<img src='../../assets/icons/magnesium_chloride_anhydrous.png' class='mmd-ico' />anhydrous magnesium chloride"]
  i_dc_charge["<img src='../../assets/icons/dc_charge.png' class='mmd-ico' />DC power charge"]
...
<div class="rc-meta"><span class="rc-stn"><a class="stn-link" href="../../stations/#rotary_calciner_kiln">Rotary Calcining Kiln (RKEF dry/reduce)</a></span> <span class="rc-time">90s</span> <span class="rc-tier">T3</span> <span class="rc-energy">100 kJ</span> <span class="rc-bp">+1 byproduct</span></div>
...
<div class="rc-meta"><span class="rc-stn"><a class="stn-link" href="../../stations/#submerged_arc_furnace">Submerged-Arc Furnace (SAF)</a></span> <span class="rc-time">130s</span> <span class="rc-tier">T3</span> <span class="rc-energy">260 kJ</span> <span class="rc-bp">+1 byproduct</span></div>
...
<div class="rc-meta"><span class="rc-stn"><a class="stn-link" href="../../stations/#mg_chloride_chlorinator">Carbo-Chlorination Reactor (MgCl2)</a></span> <span class="rc-time">130s</span> <span class="rc-tier">T4</span> <span class="rc-energy">140 kJ</span> <span class="rc-bp">+1 byproduct</span></div>
...
<div class="rc-meta"><span class="rc-stn"><a class="stn-link" href="../../stations/#pidgeon_retort">Pidgeon Vacuum Retort (silicothermic)</a></span> <span class="rc-time">300s</span> <span class="rc-tier">T4</span> <span class="rc-energy">220 kJ</span> <span class="rc-bp">+1 byproduct</span></div>
...
<div class="rc-meta"><span class="rc-stn"><a class="stn-link" href="../../stations/#caustic_digester_autoclave">Caustic Digester Autoclave (alkali leach)</a></span> <span class="rc-time">80s</span> <span class="rc-tier">T3</span> <span class="rc-energy">60 kJ</span> <span class="rc-bp">+1 byproduct</span></div>
...
<div class="rc-meta"><span class="rc-stn"><a class="stn-link" href="../../stations/#mg_flux_remelt_furnace">Flux-Protected Remelt Furnace (Mg)</a></span> <span class="rc-time">110s</span> <span class="rc-tier">T4</span> <span class="rc-energy">100 kJ</span></div>
...
<div class="rc-meta"><span class="rc-stn"><a class="stn-link" href="../../stations/#mg_electrolysis_cell">Fused-Salt Electrolysis Cell (Mg)</a></span> <span class="rc-time">240s</span> <span class="rc-tier">T4</span> <span class="rc-energy">420 kJ</span> <span class="rc-bp">+1 byproduct</span></div>
...
%%{init: {'securityLevel':'loose','flowchart':{'htmlLabels':true,'curve':'basis','nodeSpacing':38,'rankSpacing':70}, 'theme':'base', 'themeVariables':{'fontSize':'13px'}}}%%
graph LR
  i_natural_gas_raw["<img src='../../assets/icons/natural_gas_raw.png' class='mmd-ico' />raw natural gas"]
  i_gas_methane["<img src='../../assets/icons/gas_methane.png' class='mmd-ico' />methane gas"]
  i_gas_co2["<img src='../../assets/icons/gas_co2.png' class='mmd-ico' />carbon dioxide gas"]
  i_gas_hydrogen_sulfide["<img src='../../assets/icons/gas_hydrogen_sulfide.png' class='mmd-ico' />hydrogen sulfide gas"]
  i_gas_oxygen["<img src='../../assets/icons/gas_oxygen.png' class='mmd-ico' />oxygen gas"]
  i_sulfur_recovered["<img src='../../assets/icons/sulfur_recovered.png' class='mmd-ico' />recovered sulfur"]
  i_water_raw["<img src='../../assets/icons/water_raw.png' class='mmd-ico' />raw water"]
  i_crude_helium["<img src='../../assets/icons/crude_helium.png' class='mmd-ico' />crude helium"]
  i_gas_nitrogen["<img src='../../assets/icons/gas_nitrogen.png' class='mmd-ico' />nitrogen gas"]
  i_gas_helium["<img src='../../assets/icons/gas_helium.png' class='mmd-ico' />helium gas"]
  i_cylinder_gas_basic["<img src='../../assets/icons/cylinder_gas_basic.png' class='mmd-ico' />basic gas cylinder"]
  i_cylinder_helium["<img src='../../assets/icons/cylinder_helium.png' class='mmd-ico' />helium cylinder"]
  i_gas_syngas["<img src='../../assets/icons/gas_syngas.png' class='mmd-ico' />synthesis gas"]
  i_gas_hydrogen["<img src='../../assets/icons/gas_hydrogen.png' class='mmd-ico' />hydrogen gas"]
  i_gas_so2["<img src='../../assets/icons/gas_so2.png' class='mmd-ico' />sulfur dioxide gas"]
...
<div class="rc-meta"><span class="rc-stn"><a class="stn-link" href="../../stations/#cryo_helium_unit">Cryogenic Helium Recovery (N2 rejection) Unit</a></span> <span class="rc-time">120s</span> <span class="rc-tier">T5</span> <span class="rc-energy">200 kJ</span> <span class="rc-bp">+1 byproduct</span></div>
...
<div class="rc-meta"><span class="rc-stn"><a class="stn-link" href="../../stations/#station_gas_compressor">Gas Compressor</a></span> <span class="rc-time">30s</span> <span class="rc-tier">T4</span> <span class="rc-energy">40 kJ</span></div>
...
<div class="rc-meta"><span class="rc-stn"><a class="stn-link" href="../../stations/#helium_purifier">Helium PSA Purifier</a></span> <span class="rc-time">90s</span> <span class="rc-tier">T5</span> <span class="rc-energy">130 kJ</span></div>
...
<div class="rc-meta"><span class="rc-stn"><a class="stn-link" href="../../stations/#steam_reformer">Steam-Methane Reformer</a></span> <span class="rc-time">70s</span> <span class="rc-tier">T4</span> <span class="rc-energy">110 kJ</span> <span class="rc-bp">+1 byproduct</span></div>
...
<div class="rc-meta"><span class="rc-stn"><a class="stn-link" href="../../stations/#amine_gas_treater">Amine Gas-Sweetening Unit</a></span> <span class="rc-time">70s</span> <span class="rc-tier">T4</span> <span class="rc-energy">90 kJ</span> <span class="rc-bp">+2 byproducts</span></div>
...
<div class="rc-meta"><span class="rc-stn"><a class="stn-link" href="../../stations/#sulfur_burner">Sulfur Burner / Pyrite Roaster</a></span> <span class="rc-time">40s</span> <span class="rc-tier">T4</span> <span class="rc-energy">60 kJ</span></div>
...
<div class="rc-meta"><span class="rc-stn"><a class="stn-link" href="../../stations/#steam_reformer">Steam-Methane Reformer</a></span> <span class="rc-time">90s</span> <span class="rc-tier">T4</span> <span class="rc-energy">160 kJ</span></div>
...
<div class="rc-meta"><span class="rc-stn"><a class="stn-link" href="../../stations/#gas_well_derrick">Natural-Gas Well & Derrick</a></span> <span class="rc-time">60s</span> <span class="rc-tier">T4</span> <span class="rc-energy">40 kJ</span></div>
...
<div class="rc-meta"><span class="rc-stn"><a class="stn-link" href="../../stations/#claus_sulfur_unit">Claus Sulfur-Recovery Unit</a></span> <span class="rc-time">80s</span> <span class="rc-tier">T4</span> <span class="rc-energy">110 kJ</span> <span class="rc-bp">+1 byproduct</span></div>
...
%%{init: {'securityLevel':'loose','flowchart':{'htmlLabels':true,'curve':'basis','nodeSpacing':38,'rankSpacing':70}, 'theme':'base', 'themeVariables':{'fontSize':'13px'}}}%%
graph LR
  i_raw_ore_pentlandite["<img src='../../assets/icons/raw_ore_pentlandite.png' class='mmd-ico' />raw pentlandite ore"]
  i_nickel_concentrate["<img src='../../assets/icons/nickel_concentrate.png' class='mmd-ico' />nickel concentrate"]
  i_waste_tailings["<img src='../../assets/icons/waste_tailings.png' class='mmd-ico' />tailings"]
  i_raw_ore_silica["<img src='../../assets/icons/raw_ore_silica.png' class='mmd-ico' />raw silica ore"]
  i_gas_oxygen["<img src='../../assets/icons/gas_oxygen.png' class='mmd-ico' />oxygen gas"]
  i_nickel_matte["<img src='../../assets/icons/nickel_matte.png' class='mmd-ico' />nickel furnace matte"]
  i_slag["<img src='../../assets/icons/slag.png' class='mmd-ico' />slag"]
  i_gas_so2["<img src='../../assets/icons/gas_so2.png' class='mmd-ico' />sulfur dioxide gas"]
  i_nickel_converter_matte["<img src='../../assets/icons/nickel_converter_matte.png' class='mmd-ico' />nickel converter matte (Ni3S2)"]
  i_nickel_oxide_sinter["<img src='../../assets/icons/nickel_oxide_sinter.png' class='mmd-ico' />nickel oxide sinter"]
  i_dc_charge["<img src='../../assets/icons/dc_charge.png' class='mmd-ico' />DC power charge"]
  i_nickel_cathode["<img src='../../assets/icons/nickel_cathode.png' class='mmd-ico' />nickel cathode"]
...
<div class="rc-meta"><span class="rc-stn"><a class="stn-link" href="../../stations/#froth_flotation_cell">Froth Flotation Cell</a></span> <span class="rc-time">70s</span> <span class="rc-tier">T2</span> <span class="rc-energy">50 kJ</span> <span class="rc-bp">+1 byproduct</span></div>
...
<div class="rc-meta"><span class="rc-stn"><a class="stn-link" href="../../stations/#copper_converter">Copper Converter (Peirce-Smith)</a></span> <span class="rc-time">100s</span> <span class="rc-tier">T3</span> <span class="rc-energy">120 kJ</span> <span class="rc-bp">+2 byproducts</span></div>
...
<div class="rc-meta"><span class="rc-stn"><a class="stn-link" href="../../stations/#flash_smelting_furnace">Flash Smelting Furnace (autogenous, O2-enriched)</a></span> <span class="rc-time">110s</span> <span class="rc-tier">T3</span> <span class="rc-energy">140 kJ</span> <span class="rc-bp">+2 byproducts</span></div>
...
<div class="rc-meta"><span class="rc-stn"><a class="stn-link" href="../../stations/#roasting_pit">Roasting Pit</a></span> <span class="rc-time">90s</span> <span class="rc-tier">T3</span> <span class="rc-energy">90 kJ</span> <span class="rc-bp">+1 byproduct</span></div>
...
%%{init: {'securityLevel':'loose','flowchart':{'htmlLabels':true,'curve':'basis','nodeSpacing':38,'rankSpacing':70}, 'theme':'base', 'themeVariables':{'fontSize':'13px'}}}%%
graph LR
  i_raw_ore_sylvite["<img src='../../assets/icons/raw_ore_sylvite.png' class='mmd-ico' />raw sylvite ore"]
  i_potash_muriate["<img src='../../assets/icons/potash_muriate.png' class='mmd-ico' />muriate of potash (KCl)"]
  i_salt["<img src='../../assets/icons/salt.png' class='mmd-ico' />salt lick"]
  i_acid_sulfuric["<img src='../../assets/icons/acid_sulfuric.png' class='mmd-ico' />sulfuric acid"]
  i_potash_sulfate["<img src='../../assets/icons/potash_sulfate.png' class='mmd-ico' />sulfate of potash (K2SO4)"]
  i_gas_hcl["<img src='../../assets/icons/gas_hcl.png' class='mmd-ico' />hydrochloric acid gas"]
  i_water_raw["<img src='../../assets/icons/water_raw.png' class='mmd-ico' />raw water"]
  i_dc_charge["<img src='../../assets/icons/dc_charge.png' class='mmd-ico' />DC power charge"]
  i_potassium_hydroxide["<img src='../../assets/icons/potassium_hydroxide.png' class='mmd-ico' />caustic potash (KOH)"]
  i_gas_chlorine["<img src='../../assets/icons/gas_chlorine.png' class='mmd-ico' />chlorine gas"]
  i_gas_hydrogen["<img src='../../assets/icons/gas_hydrogen.png' class='mmd-ico' />hydrogen gas"]
...
<div class="rc-meta"><span class="rc-stn"><a class="stn-link" href="../../stations/#froth_flotation_cell">Froth Flotation Cell</a></span> <span class="rc-time">80s</span> <span class="rc-tier">T3</span> <span class="rc-energy">55 kJ</span> <span class="rc-bp">+1 byproduct</span></div>
...
<div class="rc-meta"><span class="rc-stn"><a class="stn-link" href="../../stations/#mannheim_furnace">Mannheim Muffle Furnace</a></span> <span class="rc-time">180s</span> <span class="rc-tier">T4</span> <span class="rc-energy">170 kJ</span> <span class="rc-bp">+1 byproduct</span></div>
...
<div class="rc-meta"><span class="rc-stn"><a class="stn-link" href="../../stations/#membrane_electrolysis_cell">Chlor-Alkali Membrane Cell</a></span> <span class="rc-time">160s</span> <span class="rc-tier">T4</span> <span class="rc-energy">420 kJ</span> <span class="rc-bp">+2 byproducts</span></div>
...
graph LR
  i_raw_ore_silica["<img src='../../assets/icons/raw_ore_silica.png' class='mmd-ico' />raw silica ore"]
  i_coke_fuel["<img src='../../assets/icons/coke_fuel.png' class='mmd-ico' />coke fuel"]
  i_silicon_mg_grade["<img src='../../assets/icons/silicon_mg_grade.png' class='mmd-ico' />metallurgical-grade silicon"]
  i_gas_co2["<img src='../../assets/icons/gas_co2.png' class='mmd-ico' />carbon dioxide gas"]
  i_gas_hcl["<img src='../../assets/icons/gas_hcl.png' class='mmd-ico' />hydrochloric acid gas"]
  i_trichlorosilane["<img src='../../assets/icons/trichlorosilane.png' class='mmd-ico' />trichlorosilane"]
  i_gas_hydrogen["<img src='../../assets/icons/gas_hydrogen.png' class='mmd-ico' />hydrogen gas"]
  i_silicon_tetrachloride["<img src='../../assets/icons/silicon_tetrachloride.png' class='mmd-ico' />silicon tetrachloride"]
  i_polysilicon_9n["<img src='../../assets/icons/polysilicon_9n.png' class='mmd-ico' />electronic-grade polysilicon"]
  i_silicon_ingot_czochralski["<img src='../../assets/icons/silicon_ingot_czochralski.png' class='mmd-ico' />Czochralski silicon ingot"]
  i_silicon_wafer_raw["<img src='../../assets/icons/silicon_wafer_raw.png' class='mmd-ico' />raw silicon wafer"]
  i_silicon_wafer_polished["<img src='../../assets/icons/silicon_wafer_polished.png' class='mmd-ico' />polished silicon wafer"]
...
<div class="rc-meta"><span class="rc-stn"><a class="stn-link" href="../../stations/#siemens_cvd_reactor">Siemens CVD Reactor (polysilicon deposition)</a></span> <span class="rc-time">200s</span> <span class="rc-tier">T4</span> <span class="rc-energy">380 kJ</span> <span class="rc-bp">+2 byproducts</span></div>
...
<div class="rc-meta"><span class="rc-stn"><a class="stn-link" href="../../stations/#czochralski_crystal_puller">Czochralski Crystal Puller</a></span> <span class="rc-time">180s</span> <span class="rc-tier">T4</span> <span class="rc-energy">300 kJ</span></div>
...
<div class="rc-meta"><span class="rc-stn"><a class="stn-link" href="../../stations/#submerged_arc_furnace">Submerged-Arc Furnace (SAF)</a></span> <span class="rc-time">120s</span> <span class="rc-tier">T3</span> <span class="rc-energy">260 kJ</span> <span class="rc-bp">+1 byproduct</span></div>
...
<div class="rc-meta"><span class="rc-stn"><a class="stn-link" href="../../stations/#wafer_fab_line">Wafer Slicing & Polishing Line</a></span> <span class="rc-time">50s</span> <span class="rc-tier">T4</span> <span class="rc-energy">70 kJ</span></div>
...
<div class="rc-meta"><span class="rc-stn"><a class="stn-link" href="../../stations/#wafer_fab_line">Wafer Slicing & Polishing Line</a></span> <span class="rc-time">60s</span> <span class="rc-tier">T4</span> <span class="rc-energy">80 kJ</span></div>
...
<div class="rc-meta"><span class="rc-stn"><a class="stn-link" href="../../stations/#fluidized_bed_chlorinator">Fluidised-Bed Chlorinator</a></span> <span class="rc-time">70s</span> <span class="rc-tier">T4</span> <span class="rc-energy">90 kJ</span> <span class="rc-bp">+1 byproduct</span></div>
...
<div class="rc-meta"><span class="rc-stn"><a class="stn-link" href="../../stations/#fluidized_bed_chlorinator">Fluidised-Bed Chlorinator</a></span> <span class="rc-time">80s</span> <span class="rc-tier">T4</span> <span class="rc-energy">110 kJ</span></div>
...
%%{init: {'securityLevel':'loose','flowchart':{'htmlLabels':true,'curve':'basis','nodeSpacing':38,'rankSpacing':70}, 'theme':'base', 'themeVariables':{'fontSize':'13px'}}}%%
graph LR
  i_raw_ore_pyrite["<img src='../../assets/icons/raw_ore_pyrite.png' class='mmd-ico' />raw pyrite ore"]
  i_gas_so2["<img src='../../assets/icons/gas_so2.png' class='mmd-ico' />sulfur dioxide gas"]
  i_roasted_ore_hematite["<img src='../../assets/icons/roasted_ore_hematite.png' class='mmd-ico' />roasted hematite"]
  i_gas_so3["<img src='../../assets/icons/gas_so3.png' class='mmd-ico' />sulfur trioxide gas"]
  i_water_raw["<img src='../../assets/icons/water_raw.png' class='mmd-ico' />raw water"]
  i_oleum["<img src='../../assets/icons/oleum.png' class='mmd-ico' />oleum (fuming sulfuric acid)"]
  i_acid_sulfuric["<img src='../../assets/icons/acid_sulfuric.png' class='mmd-ico' />sulfuric acid"]
  i_acid_sulfuric_dilute["<img src='../../assets/icons/acid_sulfuric_dilute.png' class='mmd-ico' />chamber acid (dilute H2SO4)"]
...
<div class="rc-meta"><span class="rc-stn"><a class="stn-link" href="../../stations/#absorption_tower">Oleum Absorption Tower</a></span> <span class="rc-time">20s</span> <span class="rc-tier">T4</span> <span class="rc-energy">12 kJ</span></div>
...
<div class="rc-meta"><span class="rc-stn"><a class="stn-link" href="../../stations/#lead_chamber">Lead Chamber (NOx)</a></span> <span class="rc-time">35s</span> <span class="rc-tier">T3</span> <span class="rc-energy">25 kJ</span></div>
...
<div class="rc-meta"><span class="rc-stn"><a class="stn-link" href="../../stations/#lead_chamber">Lead Chamber (NOx)</a></span> <span class="rc-time">40s</span> <span class="rc-tier">T3</span> <span class="rc-energy">15 kJ</span></div>
...
<div class="rc-meta"><span class="rc-stn"><a class="stn-link" href="../../stations/#sulfur_burner">Sulfur Burner / Pyrite Roaster</a></span> <span class="rc-time">50s</span> <span class="rc-tier">T2</span> <span class="rc-energy">40 kJ</span> <span class="rc-bp">+1 byproduct</span></div>
...
<div class="rc-meta"><span class="rc-stn"><a class="stn-link" href="../../stations/#contact_converter">Contact Converter (V2O5 beds, DCDA)</a></span> <span class="rc-time">30s</span> <span class="rc-tier">T4</span> <span class="rc-energy">60 kJ</span></div>
...
<div class="rc-meta"><span class="rc-stn"><a class="stn-link" href="../../stations/#absorption_tower">Oleum Absorption Tower</a></span> <span class="rc-time">20s</span> <span class="rc-tier">T4</span> <span class="rc-energy">18 kJ</span></div>
...
%%{init: {'securityLevel':'loose','flowchart':{'htmlLabels':true,'curve':'basis','nodeSpacing':38,'rankSpacing':70}, 'theme':'base', 'themeVariables':{'fontSize':'13px'}}}%%
graph LR
  i_raw_ore_sphalerite["<img src='../../assets/icons/raw_ore_sphalerite.png' class='mmd-ico' />raw sphalerite ore"]
  i_concentrate_sphalerite["<img src='../../assets/icons/concentrate_sphalerite.png' class='mmd-ico' />sphalerite concentrate"]
  i_waste_tailings["<img src='../../assets/icons/waste_tailings.png' class='mmd-ico' />tailings"]
  i_gas_oxygen["<img src='../../assets/icons/gas_oxygen.png' class='mmd-ico' />oxygen gas"]
  i_zinc_calcine_oxide["<img src='../../assets/icons/zinc_calcine_oxide.png' class='mmd-ico' />zinc oxide calcine"]
  i_gas_so2["<img src='../../assets/icons/gas_so2.png' class='mmd-ico' />sulfur dioxide gas"]
  i_acid_sulfuric["<img src='../../assets/icons/acid_sulfuric.png' class='mmd-ico' />sulfuric acid"]
  i_zinc_sulfate_solution["<img src='../../assets/icons/zinc_sulfate_solution.png' class='mmd-ico' />zinc sulfate liquor"]
  i_dc_charge["<img src='../../assets/icons/dc_charge.png' class='mmd-ico' />DC power charge"]
  i_metal_zinc_ingot["<img src='../../assets/icons/metal_zinc_ingot.png' class='mmd-ico' />zinc ingot"]
  i_coke_fuel["<img src='../../assets/icons/coke_fuel.png' class='mmd-ico' />coke fuel"]
  i_gas_co2["<img src='../../assets/icons/gas_co2.png' class='mmd-ico' />carbon dioxide gas"]
...
<div class="rc-meta"><span class="rc-stn"><a class="stn-link" href="../../stations/#electrowinning_cell">Electrowinning Cell (Pb anode / SS cathode)</a></span> <span class="rc-time">150s</span> <span class="rc-tier">T4</span> <span class="rc-energy">380 kJ</span> <span class="rc-bp">+1 byproduct</span></div>
...
<div class="rc-meta"><span class="rc-stn"><a class="stn-link" href="../../stations/#zinc_distillation_retort">Zinc Distillation Retort (thermal)</a></span> <span class="rc-time">180s</span> <span class="rc-tier">T3</span> <span class="rc-energy">260 kJ</span> <span class="rc-bp">+1 byproduct</span></div>
...
<div class="rc-meta"><span class="rc-stn"><a class="stn-link" href="../../stations/#roasting_pit">Roasting Pit</a></span> <span class="rc-time">110s</span> <span class="rc-tier">T3</span> <span class="rc-energy">120 kJ</span> <span class="rc-bp">+1 byproduct</span></div>
...
<div class="rc-meta"><span class="rc-stn"><a class="stn-link" href="../../stations/#heap_leach_pad">Heap Leach Pad (acid irrigation)</a></span> <span class="rc-time">120s</span> <span class="rc-tier">T3</span> <span class="rc-energy">80 kJ</span> <span class="rc-bp">+1 byproduct</span></div>
