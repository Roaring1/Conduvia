...
graph LR
  i_forest_seed_mix_dry["<img src='/Conduvia/assets/icons/forest_seed_mix_dry.png' class='mmd-ico' />dry forest seed mix"]
  i_flax_seed["<img src='/Conduvia/assets/icons/flax_seed.png' class='mmd-ico' />flax seed"]
  i_turnip_seed["<img src='/Conduvia/assets/icons/turnip_seed.png' class='mmd-ico' />turnip seed"]
  i_carrot_seed["<img src='/Conduvia/assets/icons/carrot_seed.png' class='mmd-ico' />carrot seed"]
  i_flax["<img src='/Conduvia/assets/icons/flax.png' class='mmd-ico' />flax stalks"]
  i_plant_fibers["<img src='/Conduvia/assets/icons/plant_fibers.png' class='mmd-ico' />plant fibers"]
...
<div class="rc-out">:ci[flax_seed|2] :ci[turnip_seed|2] :ci[carrot_seed|2]</div>
<div class="rc-flow">:ci[forest_seed_mix_dry|3] <span class="rc-arrow">→</span> :ci[flax_seed|2] :ci[turnip_seed|2] :ci[carrot_seed|2]</div>
<div class="rc-meta"><span class="rc-stn">Camp Marker</span> <span class="rc-time">120.0s</span> <span class="rc-tier">T0</span> <span class="rc-bp">+2 byproducts</span></div>
...
<div class="recipe-card cat-crafting" markdown>
<div class="rc-out">:ci[plant_fibers|3]</div>
<div class="rc-flow">:ci[flax|2] <span class="rc-arrow">→</span> :ci[plant_fibers|3]</div>
<div class="rc-meta"><span class="rc-stn">Camp Marker</span> <span class="rc-time">300.0s</span> <span class="rc-tier">T0</span></div>
...
%%{init: {'securityLevel':'loose','flowchart':{'htmlLabels':true,'curve':'basis','nodeSpacing':38,'rankSpacing':70}, 'theme':'base', 'themeVariables':{'fontSize':'13px'}}}%%
graph LR
  i_raw_ore_flint["<img src='/Conduvia/assets/icons/raw_ore_flint.png' class='mmd-ico' />raw flint"]
  i_flint_flake["<img src='/Conduvia/assets/icons/flint_flake.png' class='mmd-ico' />flint flake"]
  i_stone_flakes["<img src='/Conduvia/assets/icons/stone_flakes.png' class='mmd-ico' />stone flakes"]
  i_flint_blade_knapped["<img src='/Conduvia/assets/icons/flint_blade_knapped.png' class='mmd-ico' />knapped flint blade"]
  i_flint_arrowhead["<img src='/Conduvia/assets/icons/flint_arrowhead.png' class='mmd-ico' />flint arrowhead"]
  i_steel_ingot["<img src='/Conduvia/assets/icons/steel_ingot.png' class='mmd-ico' />steel ingot"]
  i_fire_steel_striker["<img src='/Conduvia/assets/icons/fire_steel_striker.png' class='mmd-ico' />flint-and-steel striker"]
  i_flint_calcined_silica["<img src='/Conduvia/assets/icons/flint_calcined_silica.png' class='mmd-ico' />calcined potters’ flint"]
...
<div class="rc-out">:ci[fire_steel_striker|2]</div>
<div class="rc-flow">:ci[raw_ore_flint|1] :ci[steel_ingot|1] <span class="rc-arrow">→</span> :ci[fire_steel_striker|2]</div>
<div class="rc-meta"><span class="rc-stn">Workbench</span> <span class="rc-time">60s</span> <span class="rc-tier">T2</span> <span class="rc-energy">25 kJ</span></div>
...
<div class="rc-out">:ci[flint_arrowhead|2]</div>
<div class="rc-flow">:ci[flint_flake|1] <span class="rc-arrow">→</span> :ci[flint_arrowhead|2]</div>
<div class="rc-meta"><span class="rc-stn">Knapping Station (anvil stone + billet)</span> <span class="rc-time">25s</span> <span class="rc-tier">T1</span> <span class="rc-energy">5 kJ</span></div>
...
<div class="recipe-card cat-knapping" markdown>
<div class="rc-out">:ci[flint_blade_knapped|1]</div>
<div class="rc-flow">:ci[flint_flake|2] <span class="rc-arrow">→</span> :ci[flint_blade_knapped|1]</div>
<div class="rc-meta"><span class="rc-stn">Knapping Station (anvil stone + billet)</span> <span class="rc-time">40s</span> <span class="rc-tier">T1</span> <span class="rc-energy">8 kJ</span></div>
...
<div class="rc-out">:ci[flint_calcined_silica|2]</div>
<div class="rc-flow">:ci[raw_ore_flint|2] <span class="rc-arrow">→</span> :ci[flint_calcined_silica|2]</div>
<div class="rc-meta"><span class="rc-stn">Rotary Calcining Kiln (RKEF dry/reduce)</span> <span class="rc-time">200s</span> <span class="rc-tier">T2</span> <span class="rc-energy">150 kJ</span></div>
...
<div class="recipe-card cat-knapping" markdown>
<div class="rc-out">:ci[flint_flake|3] :ci[stone_flakes|1]</div>
<div class="rc-flow">:ci[raw_ore_flint|2] <span class="rc-arrow">→</span> :ci[flint_flake|3] :ci[stone_flakes|1]</div>
<div class="rc-meta"><span class="rc-stn">Knapping Station (anvil stone + billet)</span> <span class="rc-time">30s</span> <span class="rc-tier">T1</span> <span class="rc-energy">6 kJ</span> <span class="rc-bp">+1 byproduct</span></div>
...
%%{init: {'securityLevel':'loose','flowchart':{'htmlLabels':true,'curve':'basis','nodeSpacing':38,'rankSpacing':70}, 'theme':'base', 'themeVariables':{'fontSize':'13px'}}}%%
graph LR
  i_raw_ore_obsidian["<img src='/Conduvia/assets/icons/raw_ore_obsidian.png' class='mmd-ico' />raw obsidian"]
  i_obsidian_flake["<img src='/Conduvia/assets/icons/obsidian_flake.png' class='mmd-ico' />obsidian flake"]
  i_stone_flakes["<img src='/Conduvia/assets/icons/stone_flakes.png' class='mmd-ico' />stone flakes"]
  i_wood["<img src='/Conduvia/assets/icons/wood.png' class='mmd-ico' />construction wood"]
  i_obsidian_blade_pressure["<img src='/Conduvia/assets/icons/obsidian_blade_pressure.png' class='mmd-ico' />pressure-flaked obsidian blade"]
  i_obsidian_arrowhead["<img src='/Conduvia/assets/icons/obsidian_arrowhead.png' class='mmd-ico' />obsidian dart point"]
  i_obsidian_scalpel["<img src='/Conduvia/assets/icons/obsidian_scalpel.png' class='mmd-ico' />obsidian scalpel"]
...
<div class="recipe-grid" markdown>
<div class="recipe-card cat-knapping" markdown>
<div class="rc-out">:ci[obsidian_arrowhead|2]</div>
...
<div class="recipe-card cat-knapping" markdown>
<div class="rc-out">:ci[obsidian_blade_pressure|1]</div>
<div class="rc-flow">:ci[obsidian_flake|2] :ci[wood|1] <span class="rc-arrow">→</span> :ci[obsidian_blade_pressure|1]</div>
<div class="rc-meta"><span class="rc-stn">Knapping Station (anvil stone + billet)</span> <span class="rc-time">50s</span> <span class="rc-tier">T2</span> <span class="rc-energy">10 kJ</span></div>
...
<div class="recipe-card cat-knapping" markdown>
<div class="rc-out">:ci[obsidian_flake|3] :ci[stone_flakes|1]</div>
...
<div class="recipe-card cat-assembly" markdown>
<div class="rc-out">:ci[obsidian_scalpel|1]</div>
<div class="rc-flow">:ci[obsidian_blade_pressure|1] :ci[wood|1] <span class="rc-arrow">→</span> :ci[obsidian_scalpel|1]</div>
<div class="rc-meta"><span class="rc-stn">Carving Bench</span> <span class="rc-time">90s</span> <span class="rc-tier">T3</span> <span class="rc-energy">30 kJ</span></div>
...
%%{init: {'securityLevel':'loose','flowchart':{'htmlLabels':true,'curve':'basis','nodeSpacing':38,'rankSpacing':70}, 'theme':'base', 'themeVariables':{'fontSize':'13px'}}}%%
graph LR
  i_stone_river_rounded["<img src='/Conduvia/assets/icons/stone_river_rounded.png' class='mmd-ico' />rounded river stone"]
  i_hammerstone["<img src='/Conduvia/assets/icons/hammerstone.png' class='mmd-ico' />hammerstone"]
  i_stone_axe_head["<img src='/Conduvia/assets/icons/stone_axe_head.png' class='mmd-ico' />stone axe head"]
  i_stone_flakes["<img src='/Conduvia/assets/icons/stone_flakes.png' class='mmd-ico' />stone flakes"]
  i_stick_dry_small["<img src='/Conduvia/assets/icons/stick_dry_small.png' class='mmd-ico' />small dry sticks"]
  ...
  i_stone_axe_ground["<img src='/Conduvia/assets/icons/stone_axe_ground.png' class='mmd-ico' />ground stone axe"]
...
<div class="recipe-grid" markdown>
<div class="recipe-card cat-crafting" markdown>
<div class="rc-out">:ci[stone_axe_ground|1]</div>
<div class="rc-flow">:ci[stone_axe_head|1] :ci[wood_haft|1] :ci[rope|1] <span class="rc-arrow">→</span> :ci[stone_axe_ground|1]</div>
<div class="rc-meta"><span class="rc-stn">Camp Marker</span> <span class="rc-time">240.0s</span> <span class="rc-tier">T0</span></div>
...
<div class="recipe-card cat-crafting" markdown>
<div class="rc-out">:ci[stone_axe_head|1] :ci[stone_flakes|3]</div>
...
<div class="rc-meta"><span class="rc-stn">Camp Marker</span> <span class="rc-time">600.0s</span> <span class="rc-tier">T0</span> <span class="rc-bp">+1 byproduct</span></div>
...
<div class="recipe-card cat-crafting" markdown>
<div class="rc-out">:ci[wood_haft|1]</div>
...
%%{init: {'securityLevel':'loose','flowchart':{'htmlLabels':true,'curve':'basis','nodeSpacing':38,'rankSpacing':70}, 'theme':'base', 'themeVariables':{'fontSize':'13px'}}}%%
graph LR
  i_dirt["<img src='/Conduvia/assets/icons/dirt.png' class='mmd-ico' />loose dirt"]
  i_bark_bucket_water["<img src='/Conduvia/assets/icons/bark_bucket_water.png' class='mmd-ico' />water-filled bark bucket"]
  i_plant_fibers["<img src='/Conduvia/assets/icons/plant_fibers.png' class='mmd-ico' />plant fibers"]
  i_clay["<img src='/Conduvia/assets/icons/clay.png' class='mmd-ico' />raw clay"]
  i_fat_raw["<img src='/Conduvia/assets/icons/fat_raw.png' class='mmd-ico' />raw animal fat"]
  i_grease_tallow["<img src='/Conduvia/assets/icons/grease_tallow.png' class='mmd-ico' />grease (tallow)"]
  i_hemp_fiber["<img src='/Conduvia/assets/icons/hemp_fiber.png' class='mmd-ico' />hemp fiber"]
  i_sail_cloth["<img src='/Conduvia/assets/icons/sail_cloth.png' class='mmd-ico' />sail cloth"]
  i_earthenware_brick["<img src='/Conduvia/assets/icons/earthenware_brick.png' class='mmd-ico' />earthenware brick"]
  i_pestle_stone["<img src='/Conduvia/assets/icons/pestle_stone.png' class='mmd-ico' />stone pestle"]
  i_grog_crushed_ceramic_temper["<img src='/Conduvia/assets/icons/grog_crushed_ceramic_temper.png' class='mmd-ico' />grog (crushed ceramic temper)"]
  i_sand["<img src='/Conduvia/assets/icons/sand.png' class='mmd-ico' />loose sand"]
  i_temper_sand_or_grog["<img src='/Conduvia/assets/icons/temper_sand_or_grog.png' class='mmd-ico' />temper (sand or grog)"]
  i_wood["<img src='/Conduvia/assets/icons/wood.png' class='mmd-ico' />construction wood"]
  i_plain_bearing_wood["<img src='/Conduvia/assets/icons/plain_bearing_wood.png' class='mmd-ico' />plain bearing (wood)"]
  i_stone_flakes["<img src='/Conduvia/assets/icons/stone_flakes.png' class='mmd-ico' />stone flakes"]
  i_wooden_peg["<img src='/Conduvia/assets/icons/wooden_peg.png' class='mmd-ico' />wooden peg"]
  i_board_plank_rough["<img src='/Conduvia/assets/icons/board_plank_rough.png' class='mmd-ico' />rough board plank"]
  i_rope["<img src='/Conduvia/assets/icons/rope.png' class='mmd-ico' />rope"]
  i_wooden_tub["<img src='/Conduvia/assets/icons/wooden_tub.png' class='mmd-ico' />wooden tub"]
  i_stone["<img src='/Conduvia/assets/icons/stone.png' class='mmd-ico' />fieldstone"]
  i_charcoal_retort_kiln["<img src='/Conduvia/assets/icons/charcoal_retort_kiln.png' class='mmd-ico' />charcoal retort kiln"]
  i_charcoal["<img src='/Conduvia/assets/icons/charcoal.png' class='mmd-ico' />charcoal"]
  i_tar["<img src='/Conduvia/assets/icons/tar.png' class='mmd-ico' />tar"]
  i_pitch["<img src='/Conduvia/assets/icons/pitch.png' class='mmd-ico' />pitch"]
  i_log_medium_dry["<img src='/Conduvia/assets/icons/log_medium_dry.png' class='mmd-ico' />medium dry log"]
  i_tool_stone_flake["<img src='/Conduvia/assets/icons/tool_stone_flake.png' class='mmd-ico' />stone flake"]
  i_stripped_log["<img src='/Conduvia/assets/icons/stripped_log.png' class='mmd-ico' />stripped log"]
  i_forest_bark_slabs["<img src='/Conduvia/assets/icons/forest_bark_slabs.png' class='mmd-ico' />bark slabs"]
  i_forest_bark_strip["<img src='/Conduvia/assets/icons/forest_bark_strip.png' class='mmd-ico' />curled bark strip"]
  i_stick_dry_small["<img src='/Conduvia/assets/icons/stick_dry_small.png' class='mmd-ico' />small dry sticks"]
  i_wood_haft["<img src='/Conduvia/assets/icons/wood_haft.png' class='mmd-ico' />wood haft"]
...
<div class="recipe-grid" markdown>
<div class="recipe-card cat-crafting" markdown>
<div class="rc-out">:ci[board_plank_rough|2] :ci[stick_dry_small|1]</div>
...
<div class="rc-meta"><span class="rc-stn">Camp Marker</span> <span class="rc-time">200.0s</span> <span class="rc-tier">T0</span> <span class="rc-bp">+1 byproduct</span></div>
...
<div class="recipe-card cat-crafting" markdown>
<div class="rc-out">:ci[charcoal|5] :ci[tar|1]</div>
<div class="rc-flow">:ci[wood|8] <span class="rc-arrow">→</span> :ci[charcoal|5] :ci[tar|1]</div>
<div class="rc-meta"><span class="rc-stn">Charcoal Retort Kiln</span> <span class="rc-time">720.0s</span> <span class="rc-tier">T0</span> <span class="rc-bp">+1 byproduct</span></div>
...
<div class="recipe-card cat-crafting" markdown>
<div class="rc-out">:ci[charcoal_retort_kiln|1]</div>
<div class="rc-flow">:ci[earthenware_brick|6] :ci[clay|4] :ci[stone|4] <span class="rc-arrow">→</span> :ci[charcoal_retort_kiln|1]</div>
<div class="rc-meta"><span class="rc-stn">Camp Marker</span> <span class="rc-time">600.0s</span> <span class="rc-tier">T0</span></div>
...
<div class="rc-meta"><span class="rc-stn">Camp Marker</span> <span class="rc-time">30.0s</span> <span class="rc-tier">T0</span></div>
...
<div class="recipe-card cat-crafting" markdown>
<div class="rc-out">:ci[grease_tallow|1]</div>
<div class="rc-flow">:ci[fat_raw|2] <span class="rc-arrow">→</span> :ci[grease_tallow|1]</div>
<div class="rc-meta"><span class="rc-stn">Survival Campfire</span> <span class="rc-time">240.0s</span> <span class="rc-tier">T0</span></div>
...
<div class="recipe-card cat-crafting" markdown>
<div class="rc-out">:ci[grog_crushed_ceramic_temper|2]</div>
<div class="rc-flow">:ci[earthenware_brick|1] :ci[pestle_stone|0] <span class="rc-arrow">→</span> :ci[grog_crushed_ceramic_temper|2]</div>
<div class="rc-meta"><span class="rc-stn">Camp Marker</span> <span class="rc-time">180.0s</span> <span class="rc-tier">T0</span></div>
...
<div class="recipe-card cat-crafting" markdown>
<div class="rc-out">:ci[hemp_fiber|1]</div>
<div class="rc-flow">:ci[plant_fibers|3] <span class="rc-arrow">→</span> :ci[hemp_fiber|1]</div>
<div class="rc-meta"><span class="rc-stn">Camp Marker</span> <span class="rc-time">360.0s</span> <span class="rc-tier">T0</span></div>
...
<div class="recipe-card cat-crafting" markdown>
<div class="rc-out">:ci[plain_bearing_wood|1]</div>
<div class="rc-flow">:ci[wood|1] :ci[grease_tallow|1] <span class="rc-arrow">→</span> :ci[plain_bearing_wood|1]</div>
<div class="rc-meta"><span class="rc-stn">Camp Marker</span> <span class="rc-time">200.0s</span> <span class="rc-tier">T0</span></div>
...
<div class="recipe-card cat-crafting" markdown>
<div class="rc-out">:ci[sail_cloth|1]</div>
<div class="rc-flow">:ci[hemp_fiber|4] <span class="rc-arrow">→</span> :ci[sail_cloth|1]</div>
<div class="rc-meta"><span class="rc-stn">Camp Marker</span> <span class="rc-time">480.0s</span> <span class="rc-tier">T0</span></div>
...
<div class="recipe-card cat-crafting" markdown>
<div class="rc-out">:ci[stripped_log|1] :ci[forest_bark_slabs|2] :ci[forest_bark_strip|2]</div>
...
<div class="rc-meta"><span class="rc-stn">Camp Marker</span> <span class="rc-time">180.0s</span> <span class="rc-tier">T0</span> <span class="rc-bp">+2 byproducts</span></div>
...
<div class="recipe-card cat-crafting" markdown>
<div class="rc-out">:ci[temper_sand_or_grog|1]</div>
<div class="rc-flow">:ci[sand|2] <span class="rc-arrow">→</span> :ci[temper_sand_or_grog|1]</div>
<div class="rc-meta"><span class="rc-stn">Camp Marker</span> <span class="rc-time">90.0s</span> <span class="rc-tier">T0</span></div>
...
<div class="recipe-card cat-crafting" markdown>
<div class="rc-out">:ci[wood_haft|3] :ci[stick_dry_small|2]</div>
<div class="rc-flow">:ci[stripped_log|1] :ci[stone_flakes|1] <span class="rc-arrow">→</span> :ci[wood_haft|3] :ci[stick_dry_small|2]</div>
<div class="rc-meta"><span class="rc-stn">Camp Marker</span> <span class="rc-time">240.0s</span> <span class="rc-tier">T0</span> <span class="rc-bp">+1 byproduct</span></div>
...
<div class="recipe-card cat-crafting" markdown>
<div class="rc-out">:ci[wooden_peg|4]</div>
<div class="rc-flow">:ci[wood|1] :ci[stone_flakes|1] <span class="rc-arrow">→</span> :ci[wooden_peg|4]</div>
<div class="rc-meta"><span class="rc-stn">Camp Marker</span> <span class="rc-time">150.0s</span> <span class="rc-tier">T0</span></div>
...
<div class="recipe-card cat-crafting" markdown>
<div class="rc-out">:ci[wooden_tub|1]</div>
...
graph LR
  i_stone["<img src='/Conduvia/assets/icons/stone.png' class='mmd-ico' />fieldstone"]
  i_hammerstone["<img src='/Conduvia/assets/icons/hammerstone.png' class='mmd-ico' />hammerstone"]
  i_stone_adze_head["<img src='/Conduvia/assets/icons/stone_adze_head.png' class='mmd-ico' />stone adze head"]
  i_stone_flakes["<img src='/Conduvia/assets/icons/stone_flakes.png' class='mmd-ico' />stone flakes"]
  i_stone_hoe_blade["<img src='/Conduvia/assets/icons/stone_hoe_blade.png' class='mmd-ico' />stone hoe blade"]
  i_wood_haft["<img src='/Conduvia/assets/icons/wood_haft.png' class='mmd-ico' />wood haft"]
  i_rope["<img src='/Conduvia/assets/icons/rope.png' class='mmd-ico' />rope"]
  i_adze["<img src='/Conduvia/assets/icons/adze.png' class='mmd-ico' />adze"]
  i_hoe["<img src='/Conduvia/assets/icons/hoe.png' class='mmd-ico' />hoe"]
  i_board_plank_rough["<img src='/Conduvia/assets/icons/board_plank_rough.png' class='mmd-ico' />rough board plank"]
  i_shovel["<img src='/Conduvia/assets/icons/shovel.png' class='mmd-ico' />crude shovel"]
  i_wood["<img src='/Conduvia/assets/icons/wood.png' class='mmd-ico' />construction wood"]
  i_mallet["<img src='/Conduvia/assets/icons/mallet.png' class='mmd-ico' />mallet"]
  i_wedge["<img src='/Conduvia/assets/icons/wedge.png' class='mmd-ico' />wedge"]
  i_lever_pry_bar["<img src='/Conduvia/assets/icons/lever_pry_bar.png' class='mmd-ico' />lever (pry bar)"]
  i_gold_pan["<img src='/Conduvia/assets/icons/gold_pan.png' class='mmd-ico' />gold pan"]
  i_stick_dry_small["<img src='/Conduvia/assets/icons/stick_dry_small.png' class='mmd-ico' />small dry sticks"]
  i_chisel["<img src='/Conduvia/assets/icons/chisel.png' class='mmd-ico' />chisel"]
  i_drawknife["<img src='/Conduvia/assets/icons/drawknife.png' class='mmd-ico' />drawknife"]
  i_bow_saw_frame["<img src='/Conduvia/assets/icons/bow_saw_frame.png' class='mmd-ico' />bow saw frame"]
  i_shaft_wood_round["<img src='/Conduvia/assets/icons/shaft_wood_round.png' class='mmd-ico' />wooden shaft (round)"]
  i_bow_drill["<img src='/Conduvia/assets/icons/bow_drill.png' class='mmd-ico' />bow drill"]
  i_plant_fibers["<img src='/Conduvia/assets/icons/plant_fibers.png' class='mmd-ico' />plant fibers"]
  i_spindle_drill["<img src='/Conduvia/assets/icons/spindle_drill.png' class='mmd-ico' />spindle drill"]
  i_measuring_cord["<img src='/Conduvia/assets/icons/measuring_cord.png' class='mmd-ico' />measuring cord"]
  i_plumb_bob["<img src='/Conduvia/assets/icons/plumb_bob.png' class='mmd-ico' />plumb bob"]
...
<div class="recipe-grid" markdown>
<div class="recipe-card cat-crafting" markdown>
<div class="rc-out">:ci[adze|1]</div>
...
<div class="recipe-card cat-crafting" markdown>
<div class="rc-out">:ci[bow_drill|1]</div>
...
<div class="recipe-card cat-crafting" markdown>
<div class="rc-out">:ci[bow_saw_frame|1]</div>
...
<div class="recipe-card cat-crafting" markdown>
<div class="rc-out">:ci[chisel|1]</div>
...
<div class="recipe-card cat-crafting" markdown>
<div class="rc-out">:ci[drawknife|1]</div>
...
<div class="recipe-card cat-crafting" markdown>
<div class="rc-out">:ci[gold_pan|1]</div>
...
<div class="recipe-card cat-crafting" markdown>
<div class="rc-out">:ci[lever_pry_bar|1]</div>
...
<div class="recipe-card cat-crafting" markdown>
<div class="rc-out">:ci[mallet|1]</div>
...
<div class="recipe-card cat-crafting" markdown>
<div class="rc-out">:ci[measuring_cord|1]</div>
...
<div class="recipe-card cat-crafting" markdown>
<div class="rc-out">:ci[plumb_bob|1]</div>
<div class="rc-flow">:ci[stone|1] :ci[stone_flakes|1] :ci[plant_fibers|1] <span class="rc-arrow">→</span> :ci[plumb_bob|1]</div>
<div class="rc-meta"><span class="rc-stn">Camp Marker</span> <span class="rc-time">120.0s</span> <span class="rc-tier">T0</span></div>
...
<div class="recipe-card cat-crafting" markdown>
<div class="rc-out">:ci[shovel|1]</div>
...
<div class="recipe-card cat-crafting" markdown>
<div class="rc-out">:ci[spindle_drill|1]</div>
...
<div class="recipe-card cat-crafting" markdown>
<div class="rc-out">:ci[stone_adze_head|1] :ci[stone_flakes|2]</div>
<div class="rc-flow">:ci[stone|2] :ci[hammerstone|0] <span class="rc-arrow">→</span> :ci[stone_adze_head|1] :ci[stone_flakes|2]</div>
<div class="rc-meta"><span class="rc-stn">Camp Marker</span> <span class="rc-time">540.0s</span> <span class="rc-tier">T0</span> <span class="rc-bp">+1 byproduct</span></div>
...
<div class="recipe-card cat-crafting" markdown>
<div class="rc-out">:ci[stone_hoe_blade|1] :ci[stone_flakes|2]</div>
...
<div class="recipe-card cat-crafting" markdown>
<div class="rc-out">:ci[wedge|1]</div>
