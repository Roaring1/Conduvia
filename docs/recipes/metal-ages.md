...
graph LR
  i_bronze_ingot["<img src='../../assets/icons/bronze_ingot.png' class='mmd-ico' />bronze ingot"]
  i_charcoal["<img src='../../assets/icons/charcoal.png' class='mmd-ico' />charcoal"]
  i_stone_mold_ingot["<img src='../../assets/icons/stone_mold_ingot.png' class='mmd-ico' />stone ingot mold"]
  i_bronze_axe_head["<img src='../../assets/icons/bronze_axe_head.png' class='mmd-ico' />bronze axe head"]
  i_bronze_pick_head["<img src='../../assets/icons/bronze_pick_head.png' class='mmd-ico' />bronze pick head"]
  i_bronze_shovel_blade["<img src='../../assets/icons/bronze_shovel_blade.png' class='mmd-ico' />bronze shovel blade"]
  ...
  i_bronze_axe["<img src='../../assets/icons/bronze_axe.png' class='mmd-ico' />bronze axe"]
  i_bronze_pickaxe["<img src='../../assets/icons/bronze_pickaxe.png' class='mmd-ico' />bronze pickaxe"]
  i_bronze_shovel["<img src='../../assets/icons/bronze_shovel.png' class='mmd-ico' />bronze shovel"]
...
<div class="rc-meta"><span class="rc-stn"><a class="stn-link" href="../../stations/#camp_marker_basic">Camp Marker</a></span> <span class="rc-time">240s</span> <span class="rc-tier">T1</span></div>
...
<div class="rc-meta"><span class="rc-stn"><a class="stn-link" href="../../stations/#clay_casting_pit">Clay Casting Pit</a></span> <span class="rc-time">480s</span> <span class="rc-tier">T1</span> <span class="rc-bp">+1 byproduct</span></div>
...
<div class="rc-meta"><span class="rc-stn"><a class="stn-link" href="../../stations/#clay_casting_pit">Clay Casting Pit</a></span> <span class="rc-time">540s</span> <span class="rc-tier">T1</span> <span class="rc-bp">+1 byproduct</span></div>
...
%%{init: {'securityLevel':'loose','flowchart':{'htmlLabels':true,'curve':'basis','nodeSpacing':38,'rankSpacing':70}, 'theme':'base', 'themeVariables':{'fontSize':'13px'}}}%%
graph LR
  i_raw_ore_chalcopyrite["<img src='../../assets/icons/raw_ore_chalcopyrite.png' class='mmd-ico' />raw chalcopyrite ore"]
  i_crushed_ore_chalcopyrite["<img src='../../assets/icons/crushed_ore_chalcopyrite.png' class='mmd-ico' />crushed chalcopyrite"]
  i_stone_dust["<img src='../../assets/icons/stone_dust.png' class='mmd-ico' />stone dust"]
  i_ground_ore_chalcopyrite["<img src='../../assets/icons/ground_ore_chalcopyrite.png' class='mmd-ico' />ground chalcopyrite"]
  i_concentrate_chalcopyrite["<img src='../../assets/icons/concentrate_chalcopyrite.png' class='mmd-ico' />chalcopyrite concentrate"]
  i_tailings["<img src='../../assets/icons/tailings.png' class='mmd-ico' />tailings"]
  i_calcine_chalcopyrite["<img src='../../assets/icons/calcine_chalcopyrite.png' class='mmd-ico' />roasted chalcopyrite calcine"]
  ...
  i_charcoal["<img src='../../assets/icons/charcoal.png' class='mmd-ico' />charcoal"]
  i_copper_matte["<img src='../../assets/icons/copper_matte.png' class='mmd-ico' />copper matte"]
  i_slag["<img src='../../assets/icons/slag.png' class='mmd-ico' />slag"]
  i_copper_blister["<img src='../../assets/icons/copper_blister.png' class='mmd-ico' />blister copper"]
  i_copper_ingot["<img src='../../assets/icons/copper_ingot.png' class='mmd-ico' />copper ingot"]
  i_refining_slag["<img src='../../assets/icons/slag.png' class='mmd-ico' />slag"]
  i_copper_anode["<img src='../../assets/icons/copper_anode.png' class='mmd-ico' />copper anode"]
  i_copper_cathode["<img src='../../assets/icons/copper_cathode.png' class='mmd-ico' />copper cathode"]
  i_anode_slime["<img src='../../assets/icons/anode_slime.png' class='mmd-ico' />anode slime"]
  i_copper_ingot_refined["<img src='../../assets/icons/copper_ingot_refined.png' class='mmd-ico' />refined copper ingot"]
  i_copper_plate["<img src='../../assets/icons/copper_plate.png' class='mmd-ico' />copper plate"]
  i_copper_foil["<img src='../../assets/icons/copper_foil.png' class='mmd-ico' />copper foil"]
  i_copper_rod["<img src='../../assets/icons/copper_rod.png' class='mmd-ico' />copper rod"]
  i_copper_dust["<img src='../../assets/icons/copper_dust.png' class='mmd-ico' />copper dust"]
  i_raw_ore_native_copper["<img src='../../assets/icons/raw_ore_native_copper.png' class='mmd-ico' />raw native copper"]
  i_copper_wire_drawn["<img src='../../assets/icons/copper_wire_drawn.png' class='mmd-ico' />drawn copper wire"]
...
<div class="rc-meta"><span class="rc-stn"><a class="stn-link" href="../../stations/#roasting_pit">Roasting Pit</a></span> <span class="rc-time">180s</span> <span class="rc-tier">T1</span> <span class="rc-energy">30 kJ</span> <span class="rc-bp">+1 byproduct</span></div>
...
<div class="rc-meta"><span class="rc-stn"><a class="stn-link" href="../../stations/#froth_flotation_cell">Froth Flotation Cell</a></span> <span class="rc-time">120s</span> <span class="rc-tier">T1</span> <span class="rc-energy">25 kJ</span> <span class="rc-bp">+1 byproduct</span></div>
...
<div class="rc-meta"><span class="rc-stn"><a class="stn-link" href="../../stations/#clay_casting_pit">Clay Casting Pit</a></span> <span class="rc-time">60s</span> <span class="rc-tier">T2</span> <span class="rc-energy">45 kJ</span></div>
...
<div class="rc-meta"><span class="rc-stn"><a class="stn-link" href="../../stations/#copper_converter">Copper Converter (Peirce-Smith)</a></span> <span class="rc-time">200s</span> <span class="rc-tier">T2</span> <span class="rc-energy">110 kJ</span> <span class="rc-bp">+2 byproducts</span></div>
...
<div class="rc-meta"><span class="rc-stn"><a class="stn-link" href="../../stations/#electrolytic_refining_cell">Electrolytic Refining Cell</a></span> <span class="rc-time">600s</span> <span class="rc-tier">T4</span> <span class="rc-energy">850 kJ</span> <span class="rc-bp">+1 byproduct</span></div>
...
<div class="rc-meta"><span class="rc-stn"><a class="stn-link" href="../../stations/#stamp_mill_manual_trip_hammer">Trip Hammer</a></span> <span class="rc-time">30s</span> <span class="rc-tier">T1</span></div>
...
<div class="rc-meta"><span class="rc-stn"><a class="stn-link" href="../../stations/#rolling_mill_steam">Steam Rolling Mill</a></span> <span class="rc-time">50s</span> <span class="rc-tier">T3</span> <span class="rc-energy">55 kJ</span></div>
...
<div class="rc-flow">:ci[copper_blister|2] :ci[charcoal|1] <span class="rc-arrow">→</span> :ci[copper_ingot|2] :ci[slag|1]</div>
<div class="rc-meta"><span class="rc-stn"><a class="stn-link" href="../../stations/#fire_refining_furnace">Fire-Refining Furnace</a></span> <span class="rc-time">150s</span> <span class="rc-tier">T2</span> <span class="rc-energy">90 kJ</span> <span class="rc-bp">+1 byproduct</span></div>
...
<div class="rc-meta"><span class="rc-stn"><a class="stn-link" href="../../stations/#clay_crucible_small">Clay Crucible</a></span> <span class="rc-time">120s</span> <span class="rc-tier">T1</span> <span class="rc-energy">35 kJ</span></div>
...
<div class="rc-meta"><span class="rc-stn"><a class="stn-link" href="../../stations/#fire_refining_furnace">Fire-Refining Furnace</a></span> <span class="rc-time">120s</span> <span class="rc-tier">T4</span> <span class="rc-energy">320 kJ</span></div>
...
<div class="rc-meta"><span class="rc-stn"><a class="stn-link" href="../../stations/#reverberatory_furnace">Reverberatory Furnace</a></span> <span class="rc-time">240s</span> <span class="rc-tier">T2</span> <span class="rc-energy">140 kJ</span> <span class="rc-bp">+1 byproduct</span></div>
...
<div class="rc-meta"><span class="rc-stn"><a class="stn-link" href="../../stations/#rolling_mill_steam">Steam Rolling Mill</a></span> <span class="rc-time">60s</span> <span class="rc-tier">T3</span> <span class="rc-energy">50 kJ</span></div>
...
<div class="rc-meta"><span class="rc-stn"><a class="stn-link" href="../../stations/#rolling_mill_steam">Steam Rolling Mill</a></span> <span class="rc-time">45s</span> <span class="rc-tier">T3</span> <span class="rc-energy">40 kJ</span></div>
...
<div class="rc-meta"><span class="rc-stn"><a class="stn-link" href="../../stations/#wire_drawing_bench">Wire Drawing Bench</a></span> <span class="rc-time">90s</span> <span class="rc-tier">T3</span> <span class="rc-energy">45 kJ</span></div>
...
<div class="rc-meta"><span class="rc-stn"><a class="stn-link" href="../../stations/#stamp_mill_manual_trip_hammer">Trip Hammer</a></span> <span class="rc-time">45s</span> <span class="rc-tier">T1</span> <span class="rc-bp">+1 byproduct</span></div>
...
<div class="rc-meta"><span class="rc-stn"><a class="stn-link" href="../../stations/#stamp_mill_manual_trip_hammer">Trip Hammer</a></span> <span class="rc-time">60s</span> <span class="rc-tier">T1</span> <span class="rc-bp">+1 byproduct</span></div>
...
%%{init: {'securityLevel':'loose','flowchart':{'htmlLabels':true,'curve':'basis','nodeSpacing':38,'rankSpacing':70}, 'theme':'base', 'themeVariables':{'fontSize':'13px'}}}%%
graph LR
  i_raw_ore_copper_oxide["<img src='../../assets/icons/raw_ore_copper_oxide.png' class='mmd-ico' />oxidized copper ore"]
  i_crushed_ore_copper_oxide["<img src='../../assets/icons/crushed_ore_copper_oxide.png' class='mmd-ico' />crushed oxide copper ore"]
  i_stone_dust["<img src='../../assets/icons/stone_dust.png' class='mmd-ico' />stone dust"]
  i_acid_sulfuric["<img src='../../assets/icons/acid_sulfuric.png' class='mmd-ico' />sulfuric acid"]
  i_copper_pls["<img src='../../assets/icons/copper_pls.png' class='mmd-ico' />pregnant leach solution (PLS)"]
  i_tailings["<img src='../../assets/icons/tailings.png' class='mmd-ico' />tailings"]
  i_copper_rich_electrolyte["<img src='../../assets/icons/copper_rich_electrolyte.png' class='mmd-ico' />rich copper electrolyte"]
...
<div class="rc-meta"><span class="rc-stn"><a class="stn-link" href="../../stations/#electrowinning_cell">Electrowinning Cell (Pb anode / SS cathode)</a></span> <span class="rc-time">90s</span> <span class="rc-tier">T3</span> <span class="rc-energy">400 kJ</span> <span class="rc-bp">+2 byproducts</span></div>
...
<div class="rc-meta"><span class="rc-stn"><a class="stn-link" href="../../stations/#heap_leach_pad">Heap Leach Pad (acid irrigation)</a></span> <span class="rc-time">120s</span> <span class="rc-tier">T2</span> <span class="rc-energy">20 kJ</span> <span class="rc-bp">+1 byproduct</span></div>
...
<div class="rc-meta"><span class="rc-stn"><a class="stn-link" href="../../stations/#sx_mixer_settler">Solvent-Extraction Mixer-Settler (LIX)</a></span> <span class="rc-time">40s</span> <span class="rc-tier">T3</span> <span class="rc-energy">30 kJ</span> <span class="rc-bp">+1 byproduct</span></div>
...
<div class="rc-meta"><span class="rc-stn"><a class="stn-link" href="../../stations/#stamp_mill_manual_trip_hammer">Trip Hammer</a></span> <span class="rc-time">25s</span> <span class="rc-tier">T1</span> <span class="rc-energy">12 kJ</span> <span class="rc-bp">+1 byproduct</span></div>
...
%%{init: {'securityLevel':'loose','flowchart':{'htmlLabels':true,'curve':'basis','nodeSpacing':38,'rankSpacing':70}, 'theme':'base', 'themeVariables':{'fontSize':'13px'}}}%%
graph LR
  i_crushed_ore_magnetite["<img src='../../assets/icons/crushed_ore_magnetite.png' class='mmd-ico' />crushed magnetite"]
  i_ore_iron_concentrate["<img src='../../assets/icons/ore_iron_concentrate.png' class='mmd-ico' />iron ore concentrate"]
  i_tailings["<img src='../../assets/icons/tailings.png' class='mmd-ico' />tailings"]
  i_crushed_ore_hematite["<img src='../../assets/icons/crushed_ore_hematite.png' class='mmd-ico' />crushed hematite"]
  ...
  i_sinter_iron["<img src='../../assets/icons/sinter_iron.png' class='mmd-ico' />iron ore sinter"]
  i_gas_so2["<img src='../../assets/icons/gas_so2.png' class='mmd-ico' />sulfur dioxide gas"]
  i_clay["<img src='../../assets/icons/clay.png' class='mmd-ico' />raw clay"]
  i_pellet_iron_oxide["<img src='../../assets/icons/pellet_iron_oxide.png' class='mmd-ico' />iron ore pellets"]
  i_pig_iron_ingot["<img src='../../assets/icons/pig_iron_ingot.png' class='mmd-ico' />pig iron ingot"]
  i_slag["<img src='../../assets/icons/slag.png' class='mmd-ico' />slag"]
  i_iron_dri_sponge["<img src='../../assets/icons/iron_dri_sponge.png' class='mmd-ico' />sponge iron (DRI)"]
  i_gas_co2["<img src='../../assets/icons/gas_co2.png' class='mmd-ico' />carbon dioxide gas"]
  i_scrap_steel["<img src='../../assets/icons/scrap_steel.png' class='mmd-ico' />steel scrap"]
  ...
  i_metal_iron_ingot["<img src='../../assets/icons/metal_iron_ingot.png' class='mmd-ico' />iron ingot"]
  i_ferrochrome["<img src='../../assets/icons/ferrochrome.png' class='mmd-ico' />ferrochrome"]
  i_ferronickel["<img src='../../assets/icons/ferronickel.png' class='mmd-ico' />ferronickel"]
  i_stainless_steel_ingot["<img src='../../assets/icons/stainless_steel_ingot.png' class='mmd-ico' />stainless steel ingot"]
...
<div class="rc-meta"><span class="rc-stn"><a class="stn-link" href="../../stations/#dri_shaft_furnace">Direct-Reduction Shaft (coal)</a></span> <span class="rc-time">160s</span> <span class="rc-tier">T3</span> <span class="rc-energy">150 kJ</span> <span class="rc-bp">+1 byproduct</span></div>
...
<div class="rc-meta"><span class="rc-stn"><a class="stn-link" href="../../stations/#arc_furnace_electric">Electric Arc Furnace</a></span> <span class="rc-time">70s</span> <span class="rc-tier">T3</span> <span class="rc-energy">140 kJ</span> <span class="rc-bp">+1 byproduct</span></div>
...
<div class="rc-meta"><span class="rc-stn"><a class="stn-link" href="../../stations/#magnetic_separator">Wet Magnetic Separator (LIMS)</a></span> <span class="rc-time">60s</span> <span class="rc-tier">T2</span> <span class="rc-energy">35 kJ</span> <span class="rc-bp">+1 byproduct</span></div>
...
<div class="rc-meta"><span class="rc-stn"><a class="stn-link" href="../../stations/#magnetic_separator">Wet Magnetic Separator (LIMS)</a></span> <span class="rc-time">75s</span> <span class="rc-tier">T2</span> <span class="rc-energy">45 kJ</span> <span class="rc-bp">+1 byproduct</span></div>
...
<div class="rc-meta"><span class="rc-stn"><a class="stn-link" href="../../stations/#pelletizer_disc">Pelletizing Disc + Induration Kiln</a></span> <span class="rc-time">80s</span> <span class="rc-tier">T3</span> <span class="rc-energy">60 kJ</span></div>
...
<div class="rc-meta"><span class="rc-stn"><a class="stn-link" href="../../stations/#blast_furnace_small">Blast Furnace</a></span> <span class="rc-time">180s</span> <span class="rc-tier">T2</span> <span class="rc-energy">130 kJ</span> <span class="rc-bp">+1 byproduct</span></div>
...
<div class="rc-meta"><span class="rc-stn"><a class="stn-link" href="../../stations/#sinter_strand">Sinter Strand (Dwight-Lloyd)</a></span> <span class="rc-time">90s</span> <span class="rc-tier">T2</span> <span class="rc-energy">55 kJ</span> <span class="rc-bp">+1 byproduct</span></div>
...
<div class="rc-meta"><span class="rc-stn"><a class="stn-link" href="../../stations/#aod_converter">AOD Converter (Argon-Oxygen Decarburization)</a></span> <span class="rc-time">140s</span> <span class="rc-tier">T4</span> <span class="rc-energy">520 kJ</span> <span class="rc-bp">+1 byproduct</span></div>
...
<div class="rc-meta"><span class="rc-stn"><a class="stn-link" href="../../stations/#basic_oxygen_furnace">Basic Oxygen Furnace (LD converter)</a></span> <span class="rc-time">120s</span> <span class="rc-tier">T3</span> <span class="rc-energy">220 kJ</span> <span class="rc-bp">+1 byproduct</span></div>
...
<div class="rc-meta"><span class="rc-stn"><a class="stn-link" href="../../stations/#arc_furnace_electric">Electric Arc Furnace</a></span> <span class="rc-time">150s</span> <span class="rc-tier">T4</span> <span class="rc-energy">480 kJ</span> <span class="rc-bp">+1 byproduct</span></div>
...
%%{init: {'securityLevel':'loose','flowchart':{'htmlLabels':true,'curve':'basis','nodeSpacing':38,'rankSpacing':70}, 'theme':'base', 'themeVariables':{'fontSize':'13px'}}}%%
graph LR
  i_raw_ore_hematite["<img src='../../assets/icons/raw_ore_hematite.png' class='mmd-ico' />raw hematite ore"]
  i_roasted_ore_hematite["<img src='../../assets/icons/roasted_ore_hematite.png' class='mmd-ico' />roasted hematite"]
  i_raw_ore_bog_iron["<img src='../../assets/icons/raw_ore_bog_iron.png' class='mmd-ico' />raw bog iron"]
  i_roasted_ore_bog_iron["<img src='../../assets/icons/roasted_ore_bog_iron.png' class='mmd-ico' />roasted bog iron"]
  i_iron_ore_crushed["<img src='../../assets/icons/iron_ore_crushed.png' class='mmd-ico' />crushed iron ore"]
  i_charcoal["<img src='../../assets/icons/charcoal.png' class='mmd-ico' />charcoal"]
  i_iron_bloom["<img src='../../assets/icons/iron_bloom.png' class='mmd-ico' />iron bloom"]
  i_bloomery_slag["<img src='../../assets/icons/bloomery_slag.png' class='mmd-ico' />bloomery slag"]
  i_wrought_iron_billet["<img src='../../assets/icons/wrought_iron_billet.png' class='mmd-ico' />wrought iron billet"]
  i_hammer_scale["<img src='../../assets/icons/hammer_scale.png' class='mmd-ico' />hammer scale"]
  i_wrought_iron_bar["<img src='../../assets/icons/wrought_iron_bar.png' class='mmd-ico' />wrought iron bar"]
  i_raw_ore_cassiterite["<img src='../../assets/icons/raw_ore_cassiterite.png' class='mmd-ico' />raw cassiterite ore"]
  i_tin_ingot["<img src='../../assets/icons/tin_ingot.png' class='mmd-ico' />tin ingot"]
  i_copper_ingot["<img src='../../assets/icons/copper_ingot.png' class='mmd-ico' />copper ingot"]
  i_bronze_ingot["<img src='../../assets/icons/bronze_ingot.png' class='mmd-ico' />bronze ingot"]
  i_raw_ore_native_copper["<img src='../../assets/icons/raw_ore_native_copper.png' class='mmd-ico' />raw native copper"]
  i_crushed_ore_hematite["<img src='../../assets/icons/crushed_ore_hematite.png' class='mmd-ico' />crushed hematite"]
  i_waste_tailings["<img src='../../assets/icons/waste_tailings.png' class='mmd-ico' />tailings"]
  i_raw_ore_magnetite["<img src='../../assets/icons/raw_ore_magnetite.png' class='mmd-ico' />raw magnetite ore"]
  i_crushed_ore_magnetite["<img src='../../assets/icons/crushed_ore_magnetite.png' class='mmd-ico' />crushed magnetite"]
  i_waste_slag["<img src='../../assets/icons/waste_slag.png' class='mmd-ico' />slag"]
  i_crushed_slag["<img src='../../assets/icons/crushed_slag.png' class='mmd-ico' />crushed slag"]
  i_raw_ore_limestone["<img src='../../assets/icons/raw_ore_limestone.png' class='mmd-ico' />raw limestone ore"]
  i_limestone_flux["<img src='../../assets/icons/limestone_flux.png' class='mmd-ico' />limestone flux"]
  i_burned_lime_quicklime["<img src='../../assets/icons/burned_lime_quicklime.png' class='mmd-ico' />burned lime (quicklime)"]
  i_coal_bituminous["<img src='../../assets/icons/coal_bituminous.png' class='mmd-ico' />bituminous coal"]
  i_coke_fuel["<img src='../../assets/icons/coke_fuel.png' class='mmd-ico' />coke fuel"]
...
<div class="rc-meta"><span class="rc-stn"><a class="stn-link" href="../../stations/#clay_crucible_small">Clay Crucible</a></span> <span class="rc-time">150s</span> <span class="rc-tier">T1</span></div>
...
<div class="rc-meta"><span class="rc-stn"><a class="stn-link" href="../../stations/#clay_crucible_small">Clay Crucible</a></span> <span class="rc-time">240s</span> <span class="rc-tier">T1</span></div>
...
<div class="rc-meta"><span class="rc-stn"><a class="stn-link" href="../../stations/#coke_oven_beehive">Beehive Coke Oven</a></span> <span class="rc-time">600s</span> <span class="rc-tier">T1</span></div>
...
<div class="rc-meta"><span class="rc-stn"><a class="stn-link" href="../../stations/#stamp_mill_manual_trip_hammer">Trip Hammer</a></span> <span class="rc-time">60s</span> <span class="rc-tier">T1</span></div>
...
<div class="rc-meta"><span class="rc-stn"><a class="stn-link" href="../../stations/#clay_bloomery_furnace">Clay Bloomery</a></span> <span class="rc-time">360s</span> <span class="rc-tier">T1</span> <span class="rc-bp">+1 byproduct</span></div>
...
<div class="rc-meta"><span class="rc-stn"><a class="stn-link" href="../../stations/#clay_bloomery_furnace">Clay Bloomery</a></span> <span class="rc-time">420s</span> <span class="rc-tier">T1</span> <span class="rc-bp">+1 byproduct</span></div>
...
<div class="rc-meta"><span class="rc-stn"><a class="stn-link" href="../../stations/#mortar_stone">Stone Mortar</a></span> <span class="rc-time">60s</span> <span class="rc-tier">T1</span></div>
...
<div class="rc-meta"><span class="rc-stn"><a class="stn-link" href="../../stations/#roasting_pit">Roasting Pit</a></span> <span class="rc-time">90s</span> <span class="rc-tier">T1</span></div>
...
<div class="rc-meta"><span class="rc-stn"><a class="stn-link" href="../../stations/#roasting_pit">Roasting Pit</a></span> <span class="rc-time">120s</span> <span class="rc-tier">T1</span></div>
...
<div class="rc-meta"><span class="rc-stn"><a class="stn-link" href="../../stations/#clay_crucible_small">Clay Crucible</a></span> <span class="rc-time">210s</span> <span class="rc-tier">T1</span></div>
...
<div class="rc-meta"><span class="rc-stn"><a class="stn-link" href="../../stations/#iron_anvil_block">Iron Anvil</a></span> <span class="rc-time">120s</span> <span class="rc-tier">T1</span></div>
<div class="rc-note">Era 3 (~20min). Reheat and hammer the billet with overlapping blows, rotating to draw it down to an even, measurable cross-section. Surface scale here is incidental -- no byproduct; collect pigment from the consolidation step instead.</div>
...
<div class="rc-meta"><span class="rc-stn"><a class="stn-link" href="../../stations/#forge_hearth">Forge Hearth</a></span> <span class="rc-time">240s</span> <span class="rc-tier">T1</span> <span class="rc-bp">+2 byproducts</span></div>
