...
graph LR
  i_steam_charge["<img src='../../assets/icons/steam_charge.png' class='mmd-ico' />steam charge"]
  i_dc_charge["<img src='../../assets/icons/dc_charge.png' class='mmd-ico' />DC power charge"]
  i_ac_charge["<img src='../../assets/icons/ac_charge.png' class='mmd-ico' />AC power charge"]
...
<div class="rc-meta"><span class="rc-stn"><a class="stn-link" href="../../stations/#generator_ac_small">Small AC Generator</a></span> <span class="rc-time">25s</span> <span class="rc-tier">T3</span></div>
...
<div class="rc-meta"><span class="rc-stn"><a class="stn-link" href="../../stations/#generator_ac_three_phase">Three-Phase AC Generator</a></span> <span class="rc-time">25s</span> <span class="rc-tier">T3</span></div>
...
<div class="rc-meta"><span class="rc-stn"><a class="stn-link" href="../../stations/#transformer_step_up">Step-Up Transformer</a></span> <span class="rc-time">8s</span> <span class="rc-tier">T3</span></div>
...
<div class="rc-meta"><span class="rc-stn"><a class="stn-link" href="../../stations/#transformer_step_down">Step-Down Transformer</a></span> <span class="rc-time">8s</span> <span class="rc-tier">T3</span></div>
...
<div class="rc-meta"><span class="rc-stn"><a class="stn-link" href="../../stations/#dynamo_dc_workshop">DC Workshop Dynamo</a></span> <span class="rc-time">25s</span> <span class="rc-tier">T3</span></div>
...
<div class="rc-meta"><span class="rc-stn"><a class="stn-link" href="../../stations/#rectifier_mercury_arc">Mercury Arc Rectifier</a></span> <span class="rc-time">10s</span> <span class="rc-tier">T3</span></div>
...
%%{init: {'securityLevel':'loose','flowchart':{'htmlLabels':true,'curve':'basis','nodeSpacing':38,'rankSpacing':70}, 'theme':'base', 'themeVariables':{'fontSize':'13px'}}}%%
graph LR
  i_raw_ore_chromite["<img src='../../assets/icons/raw_ore_chromite.png' class='mmd-ico' />raw chromite ore"]
  i_crushed_ore_chromite["<img src='../../assets/icons/crushed_ore_chromite.png' class='mmd-ico' />crushed chromite ore"]
  i_stone_dust["<img src='../../assets/icons/stone_dust.png' class='mmd-ico' />stone dust"]
  i_pellet_chromite["<img src='../../assets/icons/pellet_chromite.png' class='mmd-ico' />indurated chromite pellet"]
  ...
  i_raw_ore_nickel_laterite["<img src='../../assets/icons/raw_ore_nickel_laterite.png' class='mmd-ico' />nickel laterite (saprolite)"]
  i_nickel_laterite_calcine["<img src='../../assets/icons/nickel_laterite_calcine.png' class='mmd-ico' />reduced laterite calcine"]
...
<div class="rc-meta"><span class="rc-stn"><a class="stn-link" href="../../stations/#submerged_arc_furnace">Submerged-Arc Furnace (SAF)</a></span> <span class="rc-time">150s</span> <span class="rc-tier">T4</span> <span class="rc-energy">380 kJ</span> <span class="rc-bp">+2 byproducts</span></div>
...
<div class="rc-meta"><span class="rc-stn"><a class="stn-link" href="../../stations/#submerged_arc_furnace">Submerged-Arc Furnace (SAF)</a></span> <span class="rc-time">150s</span> <span class="rc-tier">T4</span> <span class="rc-energy">360 kJ</span> <span class="rc-bp">+1 byproduct</span></div>
...
<div class="rc-meta"><span class="rc-stn"><a class="stn-link" href="../../stations/#rotary_calciner_kiln">Rotary Calcining Kiln (RKEF dry/reduce)</a></span> <span class="rc-time">90s</span> <span class="rc-tier">T3</span> <span class="rc-energy">120 kJ</span> <span class="rc-bp">+1 byproduct</span></div>
...
<div class="rc-meta"><span class="rc-stn"><a class="stn-link" href="../../stations/#pelletizer_disc">Pelletizing Disc + Induration Kiln</a></span> <span class="rc-time">45s</span> <span class="rc-tier">T3</span> <span class="rc-energy">40 kJ</span></div>
...
graph LR
  ...
  i_steam_charge["<img src='../../assets/icons/steam_charge.png' class='mmd-ico' />steam charge"]
  i_steel_plate_rolled["<img src='../../assets/icons/steel_plate_rolled.png' class='mmd-ico' />rolled steel plate"]
  i_pig_iron_ingot["<img src='../../assets/icons/pig_iron_ingot.png' class='mmd-ico' />pig iron ingot"]
  i_steel_rail["<img src='../../assets/icons/steel_rail.png' class='mmd-ico' />steel rail"]
  i_steel_beam["<img src='../../assets/icons/steel_beam.png' class='mmd-ico' />rolled steel beam"]
  i_coal_bituminous["<img src='../../assets/icons/coal_bituminous.png' class='mmd-ico' />bituminous coal"]
  i_slag_ironmaking["<img src='../../assets/icons/slag_ironmaking.png' class='mmd-ico' />blast-furnace slag"]
  ...
  i_carbon_filament_preform["<img src='../../assets/icons/carbon_filament_preform.png' class='mmd-ico' />carbon filament preform"]
  i_copper_wire_insulated["<img src='../../assets/icons/copper_wire_insulated.png' class='mmd-ico' />insulated copper wire"]
  i_incandescent_lamp_carbon["<img src='../../assets/icons/incandescent_lamp_carbon.png' class='mmd-ico' />incandescent lamp (carbon)"]
...
<div class="rc-meta"><span class="rc-stn"><a class="stn-link" href="../../stations/#glass_bench">Glass Bench</a></span> <span class="rc-time">180s</span> <span class="rc-tier">T3</span></div>
...
<div class="rc-meta"><span class="rc-stn"><a class="stn-link" href="../../stations/#glass_bench">Glass Bench</a></span> <span class="rc-time">90s</span> <span class="rc-tier">T3</span></div>
...
<div class="rc-meta"><span class="rc-stn"><a class="stn-link" href="../../stations/#rolling_mill_steam">Steam Rolling Mill</a></span> <span class="rc-time">120s</span> <span class="rc-tier">T3</span></div>
...
<div class="rc-meta"><span class="rc-stn"><a class="stn-link" href="../../stations/#open_hearth_furnace_basic">Open Hearth Furnace</a></span> <span class="rc-time">600s</span> <span class="rc-tier">T3</span> <span class="rc-bp">+1 byproduct</span></div>
...
<div class="rc-meta"><span class="rc-stn"><a class="stn-link" href="../../stations/#rolling_mill_steam">Steam Rolling Mill</a></span> <span class="rc-time">90s</span> <span class="rc-tier">T3</span></div>
...
<div class="rc-meta"><span class="rc-stn"><a class="stn-link" href="../../stations/#boiler_shell_riveted">Riveted Boiler</a></span> <span class="rc-time">20s</span> <span class="rc-tier">T4</span></div>
...
<div class="rc-meta"><span class="rc-stn"><a class="stn-link" href="../../stations/#stamp_mill_manual_trip_hammer">Trip Hammer</a></span> <span class="rc-time">90s</span> <span class="rc-tier">T2</span> <span class="rc-bp">+1 byproduct</span></div>
...
<div class="rc-meta"><span class="rc-stn"><a class="stn-link" href="../../stations/#blast_furnace_small">Blast Furnace</a></span> <span class="rc-time">480s</span> <span class="rc-tier">T2</span> <span class="rc-bp">+1 byproduct</span></div>
...
<div class="rc-meta"><span class="rc-stn"><a class="stn-link" href="../../stations/#bessemer_converter_basic">Bessemer Converter</a></span> <span class="rc-time">300s</span> <span class="rc-tier">T2</span> <span class="rc-bp">+1 byproduct</span></div>
